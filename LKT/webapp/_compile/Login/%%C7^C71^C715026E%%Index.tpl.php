<?php /* Smarty version 2.6.31, created on 2019-12-20 18:00:37
...
<html>
	...
	<body>
		...
		<div class='page'>
			<input type="hidden" id="startdate" value="<?php echo $this->_tpl_vars['res']->startdate; ?>
">
			<input type="hidden" id="enddate" value="<?php echo $this->_tpl_vars['res']->enddate; ?>
">
			<input type="hidden" id="telltype" value="<?php echo $this->_tpl_vars['res']->type; ?>
">
			<!--登陆的弹框-->
		...
		<script type="text/javascript">
			window.onload = function() {
				...
				var notice_id = \''; ?>
<?php echo $this->_tpl_vars['res']->id; ?>
<?php echo '\';
