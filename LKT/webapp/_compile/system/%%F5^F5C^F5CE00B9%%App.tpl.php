<?php /* Smarty version 2.6.31, created on 2019-12-27 15:23:53
         compiled from App.tpl */ ?>
...
<div class="page-container pd-20 page_absolute">
    <form name="form1" id='form1' class="form form-horizontal" method="post"   enctype="multipart/form-data" >
        <div id="tab-system" class="HuiTab">
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-4"><span class="c-red">*</span>app域名：</label>
                <div class="formControls col-xs-8 col-sm-6">
                    <input type="text" name="app_domain_name" value="<?php echo $this->_tpl_vars['app_domain_name']; ?>
" class="input-text">
                </div>
            </div>
        </div>
...
function check() {
    ...
    $.ajax({
        ...
        type: "POST",
        dataType:"json",
        url:\'index.php?module=system&action=app\',
        ...
        success: function(data) {
            ...
            if(data.suc){
                setTimeout(function(){
                    location.href="index.php?module=system&action=app";
                },2000)
        }
        }
    });
