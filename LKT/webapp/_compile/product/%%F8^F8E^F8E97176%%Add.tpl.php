<?php /* Smarty version 2.6.31, created on 2019-12-20 16:09:21
...
" name="product_title">
						...
						<div class="formListSD">
							...
							<div class="formInputSD">
								<input type="text" value="<?php echo $this->_tpl_vars['subtitle']; ?>
" name="subtitle">
					...
					<div class="formContentSD">
						<div class="form_li form_num formListSD">
							...
							<div class="form_new_r">
								...
								<input type="number" oninput="value=value.replace(/[^\d]/g,'')" required="required" value="<?php echo $this->_tpl_vars['min_inventory']; ?>
" min="0" name="min_inventory">
