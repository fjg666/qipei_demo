<?php /* Smarty version 2.6.31, created on 2019-12-30 14:09:55
...
<nav class="nav-title">
	<span>商品管理</span> 
	<span onclick="javascript :history.back(-1);"><span class="arrows">&gt;</span>商品列表</span> 
			...
			<div class="formContentSD">
				<div class="formListSD">
					...
					<div class="formInputSD">
						<input type="text" required="required" value="<?php echo $this->_tpl_vars['product_title']; ?>
" name="product_title">
				...
				<div class="formListSD">
					...
					<div class="formInputSD"><input type="text" value="<?php echo $this->_tpl_vars['subtitle']; ?>
" name="subtitle">
				...
				<div class="formListSD">
					...
					<div class="formInputSD"><input type="text" value="<?php echo $this->_tpl_vars['keyword']; ?>
" name="keyword">
					</div>
				</div>
				<div class="formListSD">
					...
					<div class="formInputSD">
						<input type="number" onkeypress="return noNumbers(event)" value="<?php echo $this->_tpl_vars['weight']; ?>
" min="0" name="weight">
				...
				<div class="formListSD">
					...
					<div class="formInputSD"><input type="text" required="required" value="<?php echo $this->_tpl_vars['product_number']; ?>
" name="product_number" readonly="readonly" style="background-color: #F8F8F8 !important;"></div>
				</div>
...
" class="upload-preview-img">
										<div class="form_new_words <?php if ($this->_tpl_vars['item4']->is_center): ?>set_center<?php endif; ?>" onclick="set_center(this)"><?php if ($this->_tpl_vars['item4']->is_center): ?>主图<?php else: ?>设为主图<?php endif; ?></div>
		...
		<div class="formDivSD">
			...
			<div class="formContentSD">
				<div class="formListSD">
					...
					<div class="formInputSD"><input required="required" type="number" name="initial[cbj]" onkeypress="return noNumbers(event)" min="0" onblur="set_cbj(this);" value="<?php echo $this->_tpl_vars['initial']->cbj; ?>
" placeholder="请设置商品的默认成本价" ></div>
				</div>
				<div class="formListSD">
					<div class="formTextSD"><span class="must">*</span><span>原价：</span></div>
					<div class="formInputSD"><input required="required" type="number" name="initial[yj]" onkeypress="return noNumbers(event)" min="0" onblur="set_yj(this);" value="<?php echo $this->_tpl_vars['initial']->yj; ?>
" placeholder="请设置商品的默认原价" ></div>
				</div>
				<div class="formListSD">
					<div class="formTextSD"><span class="must">*</span><span>售价：</span></div>
					<div class="formInputSD"><input required="required" type="number" name="initial[sj]" onkeypress="return noNumbers(event)" min="0" onblur="set_sj(this);" value="<?php echo $this->_tpl_vars['initial']->sj; ?>
" placeholder="请设置商品的默认售价" ></div>
				...
				<div class="formListSD">
					...
					<div class="formInputSD"><input type="number" name="initial[kucun]" oninput="value=value.replace(/[^\d]/g,'')" required="required" min="0" onblur="set_kucun(this);" value="<?php echo $this->_tpl_vars['initial']->kucun; ?>
							...
							<div>
								<table class="attr-table attr_table">
									...
									<tr v-if="index==0" v-for=\'(item,index) in strArr\' :key=\'index\'>
										...
										<td>
											<div>
												<input type="text" v-bind:name="\'attr[\'+index+\'][bar_code]\'"  v-model="item.bar_code" style=\'width: 140px!important;\'>
										...
										<td>
											<div  class="upload-group form_group form_flex">
												...
												<!-- 不存在 -->
												<div class="form_attr_img " v-else>
													<img src="images/iIcon/sha.png" class="form_new_sha file-item-delete-c"/>
													<img src="images/icon1/add_g_t.png" class="upload-preview-img form_att select-file">
												</div>
												<div class="input-group" style="display: none;">
													<input :value="item.img" class="form-control file-input" v-bind:name="\'attr[\'+index+\'][img]\'">
												</div>
											</div>
										</td>
									</tr>
									<tr v-if="index>0" v-for=\'(item,index) in strArr\' :key=\'index\'>
										...
										<td>
											<div>
												<input type="number" v-bind:name="\'attr[\'+index+\'][costprice]\'" :value="item.cbj">
											</div>
										</td>
										<td>
											<div>
												<input type="number" v-bind:name="\'attr[\'+index+\'][yprice]\'" :value="item.yj">
											</div>
										</td>
										<td>
											<div>
												<input type="number" v-bind:name="\'attr[\'+index+\'][price]\'" :value="item.sj">
											</div>
										</td>
										<td>
											<div>
												<input type="number" v-bind:name="\'attr[\'+index+\'][num]\'" :value="item.kucun">
											</div>
										</td>
										<td>
											<input type="hidden" v-bind:name="\'attr[\'+index+\'][unit]\'" :value="item.unit" style="border: 0px;background-color: transparent;" readOnly="readOnly">
											<span>{{unit}}</span>
										</td>
										<td>
											<div>
		...
		<div class="formDivSD">
			...
			<div class="formContentSD">
				<div class="form_li form_num formListSD">
					...
					<div class="form_new_r"><span class="form_li_one">当前库存量小于</span><input type="number" min="0" oninput="value=value.replace(/[^\d]/g,'')" required="required" value="<?php echo $this->_tpl_vars['min_inventory']; ?>
" name="min_inventory"><span class="form_li_one">时，商品库存报警</span><span>（可在库存列表中查看明细，预警数据将以红色加粗显示）</span></div>
				</div>
...
">
						...
						<div class="ra1">
							<input name="active" onchange="active_select(this)" type="radio" <?php if ($this->_tpl_vars['active'] == 6): ?>checked="checked"<?php endif; ?> style="display: none;" id="active-6" class="inputC1" value="6">
...
<span>（如果不选，默认显示在全部商品里）</span></div>
				...
				<div class="form_li">
					...
					<div class="form_new_r form_yes">
						<div class="ra1">
							<input name="is_hexiao" onchange="form_address(this)" type="radio" <?php if ($this->_tpl_vars['is_hexiao'] == 1): ?>checked="checked"<?php endif; ?> style="display: none;" id="is_hexiao-1" class="inputC1" value="1">
							<label for="is_hexiao-1">是</label>
						</div>
						<div class="ra1">
							<input name="is_hexiao" onchange="form_address(this)" type="radio" <?php if ($this->_tpl_vars['is_hexiao'] == 0): ?>checked="checked"<?php endif; ?> style="display: none;" id="is_hexiao-2" class="inputC1" value="0">
				...
				<div class="form_address" id="xd_hx" <?php if ($this->_tpl_vars['is_hexiao'] == 0): ?>style="display: none;"<?php endif; ?>>
					<span>核销地址：</span>
					<input type="text" name="hxaddress" value="<?php echo $this->_tpl_vars['hxaddress']; ?>
">
				</div>
			</div>
			<div class="formSpaceSD"></div>
		...
		<div class="formDivSD">
			...
			<div class="formContentSD">
				<div class="form_li form_num formListSD" style="margin-bottom: 30px;">
				...
				success: function (msg) {
					...
					if(type == \'\'){
						if(text_num - 2 == level){
							...
							if(class_list.length == 0){ // 该分类没有下级
								if($(\'.selectDiv>div\').html()==\'\'){
									str=`<p class=\'selectItem\' id=\'p1\' tyid=\'${cid}\' onclick=\'del_sel(this,${level},${cid})\'>${text}</p><p class=\'selectItem del_sel\' id=\'p2\' onclick=\'del_sel(this)\'>`
								}else{
									$(\'.del_sel\').remove()
