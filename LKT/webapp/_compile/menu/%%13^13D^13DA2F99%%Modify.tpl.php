<?php /* Smarty version 2.6.31, created on 2019-12-20 16:07:09
            ...
            <div class="formContentSD" style="padding-top: 38px;">
                <div class="formListSD" style="margin: 2px 0px 12px;">
                    ...
                    <div class="formInputSD">
                        <input type="text" class="input-text" value="<?php echo $this->_tpl_vars['title']; ?>
" placeholder="" id="" name="title" style="width: 380px;">
                    </div>
                </div>
                <div class="formListSD" style="margin: 2px 0px 12px;">
                ...
                <div class="formListSD"  id="url" <?php if ($this->_tpl_vars['level'] == 1): ?>style="display:none;margin: 2px 0px 12px;"<?php endif; ?>>
...
" placeholder="" id="" name="url">
                ...
                <div class="formListSD" id="tubiao" <?php if ($this->_tpl_vars['type'] != 0): ?>style="margin: 2px 0px 12px;"<?php endif; ?>>
                    <div class="formTextSD" style="align-items: flex-start;"><span style="height: 36px;">图标：</span></div>
                    <div class="formInputSD">
                        <div class="upload-group">
                            <div class="input-group">
                                <input class="form-control file-input border-color-d5d" name="image" value="<?php echo $this->_tpl_vars['image']; ?>
" style="width: 430px;">
                                <input type="hidden" class="form-control file-input" name="oldpic" value="<?php echo $this->_tpl_vars['image']; ?>
">
...
">
                ...
                <div class="formListSD" id="tubiao1" <?php if ($this->_tpl_vars['type'] != 0): ?>style="margin: 2px 0px 12px;"<?php endif; ?>>
                    <div class="formTextSD" style="align-items: flex-start;"><span style="height: 36px;">点击后图标：</span></div>
                    <div class="formInputSD">
                        <div class="upload-group">
                            <div class="input-group">
                                <input class="form-control file-input border-color-d5d" name="image1" value="<?php echo $this->_tpl_vars['image1']; ?>
" style="width: 430px;">
                                <input type="hidden" class="form-control file-input" name="oldpic" value="<?php echo $this->_tpl_vars['image1']; ?>
">
                                <span class="input-group-btn">
                                    <a class="btn btn-secondary upload-file border-color-d5d" href="javascript:" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="上传文件" style="display: flex;align-items: center;justify-content: center;">
                                        <span class="iconfont icon-cloudupload"></span>
                            ...
                            <div class="upload-preview text-center upload-preview border-color-d5d">
                                <span class="upload-preview-tip">320×375</span>
                                <img class="upload-preview-img" src="<?php echo $this->_tpl_vars['image1']; ?>
">
                            </div>
                        </div>
                    </div>
