<?php /* Smarty version 2.6.31, created on 2020-01-02 17:10:54
...
<div class="iframe-content" style="background-color: #fff;">
    <form name="form1" id="form1" class="form form-horizontal" method="post" enctype="multipart/form-data" style="padding: 0px;">
        <table class="table table-bg table-hover " style="width: 100%;height:100px;border-radius: 30px;">
            <div class="formDivSD">
                <div class="formTitleSD" >编辑分类</div>
                <div class="formContentSD">
                    <input type="hidden" name="cid" class="cid" value="<?php echo $this->_tpl_vars['class']->cid; ?>
" >
                    <input type="hidden" name="class[sid]" class="val" value="<?php echo $this->_tpl_vars['class']->sid; ?>
" >
                    <input type="hidden" name="class[level]" class="level" value="<?php echo $this->_tpl_vars['class']->level; ?>
" >
                    <div class="formListSD">
                        <div class="formTextSD"><span class="c-red">*</span><span>分类名称：</span></div>
                        <div class="formInputSD">
                            <input type="text" name="class[pname]" value="<?php echo $this->_tpl_vars['class']->pname; ?>
" datatype="*6-18" placeholder="请输入分类名称" />
                        </div>
                    </div>
                    <div class="formListSD" >
                        <div class="formTextSD"><span class="c-red">*</span><span>分类级别：</span></div>
                        <div class="formInputSD">
                            <select style="border: 1px solid #D5DBE8;display: flex;justify-content: center;" class="form-control link-list-select1 " name="level" onchange="slevel()" id="select_c">
                        ...
                        <div class="formInputSD upload-group multiple">
                            <div id="sortList" class="upload-preview-list uppre_auto">
                                <div class="upload-preview form_new_img" style="display: none;margin-top: -50px !important;">
                                    ...
                                    <input type="hidden" name="class[img]" class="file-item-input" value="<?php echo $this->_tpl_vars['class']->img; ?>
">
                                </div>
                            </div>
                            <div class="select-file form_new_file from_i">
                                <div>
                                    <?php if ($this->_tpl_vars['class']->img): ?>
                                        <img src="<?php echo $this->_tpl_vars['class']->img; ?>
" data-toggle="tooltip" data-placement="bottom" title="" class="btn-secondary select-file" style="width: 78px;height: 78px;"/>
                                    <?php else: ?>
...
;
    ...
    function check() {
        $.ajax({
            ...
            type: "POST",
            dataType: "json",
            url: \'index.php?module=product_class&action=Modify\',
            ...
            success: function (data) {
                ...
                if (data.suc) {
                    location.href = \'index.php?module=product_class&action=Index&cid=\'+del_str.cid+\'&pname=\'+del_str.pname+\'&pagesize=\'+del_str.pagesize+\'&page=\'+del_str.page;
                }
            }
        });
    }
