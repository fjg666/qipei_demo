<?php /* Smarty version 2.6.31, created on 2019-12-20 15:41:14
...
?>
                <tr class="tab_head">
                    <td colspan="<?php if ($this->_tpl_vars['otype'] == 't2'): ?>10<?php else: ?>9<?php endif; ?>" class="tab_tb_news">
                        <label class="custom-control custom-checkbox">
                            <input name="orders[]" value="<?php echo $this->_tpl_vars['item']->sNo; ?>
" type="checkbox"
                                   class="custom-control-input orders_select">
                            <span class="custom-control-indicator"></span>
                            <span class="custom-control-description">
                                <?php if ($this->_tpl_vars['item']->p_sNo == ''): ?>
                                    <span class="ml-ttt f9e">订单编号：<?php echo $this->_tpl_vars['item']->sNo; ?>
</span>
                                <?php else: ?>
                                    <span class="ml-ttt f9e">订单编号：<?php echo $this->_tpl_vars['item']->p_sNo; ?>
</span>
                                <?php endif; ?>
                                <?php if ($this->_tpl_vars['item']->real_sno != '' && $this->_tpl_vars['item']->status != '待付款'): ?>
                                    <span class="ml-ttt f9e">商户订单编号：<?php echo $this->_tpl_vars['item']->real_sno; ?>
</span>
                                <?php endif; ?>
                                <span class="ml-ttt f9e">创单时间：<?php echo $this->_tpl_vars['item']->add_time; ?>
</span>
								<span class="ml-ttt f9e">店铺：<?php echo $this->_tpl_vars['item']->mchname; ?>
</span>
                            </span>
                        </label>
                    </td>
...
?>
                            <!-- 只显示一个 -->
                            <?php if ($this->_tpl_vars['key2'] < 1): ?>
                                <div class="goods-item" flex="dir:left box:first">
                                    <div class="fs-0 f9e">
                                        <div class="goods-pic" style="background-image: url('<?php echo $this->_tpl_vars['item2']->imgurl; ?>
')"></div>
                                    </div>
                                    <div class="goods-info">
                                        <div class="goods-name u2523"><?php echo $this->_tpl_vars['item2']->product_title; ?>
</div>
                                        <div class="mt-1">
                                                <span class="fs-sm f9e">规格：
                                                    <span class="text-danger">
                                                        <span class="mr-3 c658 textColor"><?php echo $this->_tpl_vars['item2']->size; ?>
</span>
                                                    </span>
                                                </span>
                                        </div>
                                        <div class="mt-1">
                                            <span class="fs-sm f9e">数量：<span
                                                        class="text-danger  textColor"><?php echo $this->_tpl_vars['item2']->num; ?>
                                        ...
                                        <div>
                                            <span class="fs-sm f9e" style="display: flex;align-items: center;">小计：
                                                ...
                                                <?php if ($this->_tpl_vars['item']->otype == 'KJ' || $this->_tpl_vars['item']->otype == 'JP'): ?>
                                                    <?php echo $this->_tpl_vars['item']->z_price; ?>

                                                <?php else: ?>
                                                    <?php echo $this->_tpl_vars['item2']->num*$this->_tpl_vars['item2']->p_price; ?>

                                                <?php endif; ?>
                                                    元<?php if ($this->_tpl_vars['item']->otype == 'IN'): ?>+<img src="images/icon/integral_hei.png"
                                                                                    alt=""
                                                                                    style="width: 15px;height: 15px;"><?php echo $this->_tpl_vars['item']->allow; ?>
<?php endif; ?>
                                                </span>
                                            </span>
                                        </div>
                    ...
                    <td>
                        <?php if ($this->_tpl_vars['item']->otype == 'IN'): ?>
                            <div style="display: flex;align-items: center;">&yen;<?php echo $this->_tpl_vars['item']->p_money; ?>
+<img
                                        src="images/icon/integral_hei.png" alt=""
                                        style="width: 15px;height: 15px;"><?php echo $this->_tpl_vars['item']->p_integral; ?>
</div>
                        <?php else: ?>
...
">●</span><span
                    ...
                    <td>
                        <div>
                            <span><?php if ($this->_tpl_vars['item']->otype == 'pt'): ?>拼团订单<?php elseif ($this->_tpl_vars['item']->otype == 'JP'): ?>竞拍订单<?php elseif ($this->_tpl_vars['item']->otype == 'KJ'): ?>砍价订单<?php elseif ($this->_tpl_vars['item']->otype == 'IN'): ?>积分订单<?php elseif ($this->_tpl_vars['item']->otype == 'MS'): ?>秒杀订单<?php elseif ($this->_tpl_vars['item']->drawid > 0): ?>抽奖订单<?php else: ?>普通订单<?php endif; ?></span>
...
<?php else: ?>暂无<?php endif; ?></span>
                    ...
                    <td>
                        <div>
                                <span>
                                    <?php echo $this->_tpl_vars['item']->pay; ?>
...
?>
                                        <div class="f9e">物流单号<?php echo $this->_tpl_vars['key3']+1; ?>
：</div>
                                    <?php endforeach; endif; unset($_from); ?>
                                <?php else: ?>
...
if ($this->_foreach['f3']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['key3'] => $this->_tpl_vars['item3']):
        $this->_foreach['f3']['iteration']++;
?>
                                        <div class="goods-name" style="width:200px;"><?php echo $this->_tpl_vars['item3']; ?>
</div>
                                    <?php endforeach; endif; unset($_from); ?>
                                <?php else: ?>
                                    <div>暂无</div>
...
<?php else: ?>免邮<?php endif; ?></div>
                    ...
                    <td class="tab_dat">
                        <?php if ($this->_tpl_vars['button'][0] == 1): ?>
                            <a class="hover_a" href="index.php?module=orderslist&action=Detail&id=<?php echo $this->_tpl_vars['item']->sNo; ?>
"
                               title="订单详情">
                        ...
                        <?php if ($this->_tpl_vars['button'][1] == 1): ?>
                            <?php if ($this->_tpl_vars['item']->statu <= 3): ?>
                                <?php if ($this->_tpl_vars['item']->statu == 0 && $this->_tpl_vars['item']->is_mch == 1): ?>
                                    <div class="stopCss">
                                        <img style="margin-top: -3px;" src="images/iIcon/bianji.png"/>&nbsp;编辑订单
                                    </div>
                                <?php else: ?>
                                    <a class="hover_a"
                                       href="index.php?module=orderslist&action=Modify&id=<?php echo $this->_tpl_vars['item']->sNo; ?>
&type=updata"
                                       title="编辑订单">
                        ...
                        <?php if ($this->_tpl_vars['button'][2] == 1): ?>
                            <?php if ($this->_tpl_vars['item']->statu == 1): ?>
                                <a class="hover_a" href="index.php?module=orderslist&action=Delivery&id=<?php echo $this->_tpl_vars['item']->sNo; ?>
">
                            ...
                            <?php else: ?>
                                <?php if ($this->_tpl_vars['item']->courier_num): ?>
                                    <a class="hover_a"
                                       onclick="send_btn1(this,'<?php echo $this->_tpl_vars['item']->sNo; ?>
...
')">
                            ...
                            <?php elseif ($this->_tpl_vars['item']->courier_num != "" && $this->_tpl_vars['button'][2] == 1 && $this->_tpl_vars['item']->statu != 1): ?>
                            <?php else: ?>
                                <div class="stopCss">
