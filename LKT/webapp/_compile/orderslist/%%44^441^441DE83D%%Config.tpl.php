<?php /* Smarty version 2.6.31, created on 2019-12-30 19:34:27
        ...
        <div id="tab-system" class="HuiTab">
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-4">
                    <input type="text" name="auto_the_goods" value="<?php echo $this->_tpl_vars['auto_the_goods']; ?>
" class="input-text">
                </div>
...
" class="input-text">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-4">
                    <input type="text" name="order_after" value="<?php echo $this->_tpl_vars['order_after']; ?>
" class="input-text">
                </div>
                <label style="line-height: 30px;height: 30px;" class="col-xs-4 col-sm-0">天</label>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-8">
                    <input type="number" name="remind_day" id="remind_day" value="<?php echo $this->_tpl_vars['remind_day']; ?>
" class="input-text">
                    <text>天</text>
                    <input type="number" name="remind_hour" id="remind_hour" value="<?php echo $this->_tpl_vars['remind_hour']; ?>
" class="input-text"
            ...
            <div class="row cl sx-settime">
                ...
                <div class="formControls col-xs-8 col-sm-8">
                    <input type="number" name="sx-day" id="sx-day" value="<?php echo $this->_tpl_vars['day']; ?>
" class="input-text">
                    <text>天</text>
                    <input type="number" name="sx-hour" id="sx-hour" value="<?php echo $this->_tpl_vars['hour']; ?>
" class="input-text"
                           style="margin-left: 5px;">
                    <text>小时</text>
                </div>
        ...
        <div class="HuiTab">
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-4">
                    <input type="text" name="accesscode" value="<?php echo $this->_tpl_vars['accesscode']; ?>
" class="input-text">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-4">
                    <input type="text" name="checkword" value="<?php echo $this->_tpl_vars['checkword']; ?>
" class="input-text">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-4">
                    <input type="text" name="custid" value="<?php echo $this->_tpl_vars['custid']; ?>
" class="input-text">
                </div>
            </div>
        </div>
