<?php /* Smarty version 2.6.31, created on 2019-12-20 16:07:25
...
">
        <div>
            ...
            <input class="ipt_name" name="name" type="text" id="name" value="<?php echo $this->_tpl_vars['name']; ?>
">
        </div>
        <div class="bindQ">
        ...
        util.event(\'lay-demo\', {
            getChecked: function(othis){
                ...
                $.ajax({
                    ...
                    type: "POST",
                    dataType: "json",
                    url: \'index.php?module=client&action=Modify\',
                    data: {
                        id:id,
                        name:name,
                        id_list:id_list,
