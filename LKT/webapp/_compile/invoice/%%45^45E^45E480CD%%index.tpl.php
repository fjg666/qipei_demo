    ...
    <div class="text-c" style="display: flex;">
        ...
        <form name="form1" action="index.php" method="get" style="width: 100%;padding: 10px;">
            ...
            <select name="r_time" class="select" id="r_time" style="width: 100px;height: 31px;vertical-align: middle;">
                <option value="1" <?php if ($this->_tpl_vars['r_time'] == 1): ?>selected<?php endif; ?>>下单时间</option>
                <option value="2" <?php if ($this->_tpl_vars['r_time'] == 2): ?>selected<?php endif; ?>>付款时间</option>
                <option value="3" <?php if ($this->_tpl_vars['r_time'] == 3): ?>selected<?php endif; ?>>发货时间</option>
            </select>
...
" placeholder="请输入结束时间" id="enddate" name="enddate" style="width:150px;margin-left:5px;">
            <select name="print_type" class="select" id="print_type" style="width: 150px;height: 31px;vertical-align: middle;">
                ...
                <option value="1" <?php if ($this->_tpl_vars['print_type'] == 1): ?>selected<?php endif; ?>>已打印</option>
                <option value="2" <?php if ($this->_tpl_vars['print_type'] == 2): ?>selected<?php endif; ?>>未打印</option>
            </select>
            <!-- <select name="o_status" class="select" id="o_status" style="width: 150px;height: 31px;vertical-align: middle;">
                <option value="" >请选择订单状态</option>
                <option value="1" <?php if ($this->_tpl_vars['o_status'] == 1): ?>selected<?php endif; ?>>未发货</option>
                <option value="2" <?php if ($this->_tpl_vars['o_status'] == 2): ?>selected<?php endif; ?>>已发货</option>
            </select> -->
            <input type="text" class="input-text" style="width:150px" placeholder="请输入下单人名称" name="recipient" id="recipient" value="<?php echo $this->_tpl_vars['recipient']; ?>
">
            <input type="text" class="input-text" style="width:150px" placeholder="请输入下单人手机号" name="r_mobile" id="r_mobile" value="<?php echo $this->_tpl_vars['r_mobile']; ?>
">
            <input type="text" class="input-text" style="width:150px" placeholder="请输入订单号" name="sNo" id="sNo" value="<?php echo $this->_tpl_vars['sNo']; ?>
">
...
"></label>
                    ...
                    <td><?php echo $this->_tpl_vars['item']->sNo; ?>
</td>
                    <td class="tab_num" style="text-align: justify;"><div style="width:305px;display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:2;overflow:hidden;"><?php echo $this->_tpl_vars['item']->title; ?>
</div></td>
                    <td><?php echo $this->_tpl_vars['item']->num; ?>
</td>
                    <td style="text-align: justify;width: 219px;">
                        <?php echo $this->_tpl_vars['item']->recipient; ?>
  <?php echo $this->_tpl_vars['item']->r_mobile; ?>

                        <br />
                        <div style="width: 219px;">
                            <?php echo $this->_tpl_vars['item']->r_sheng; ?>

                            <?php echo $this->_tpl_vars['item']->r_shi; ?>

                            <?php echo $this->_tpl_vars['item']->r_xian; ?>

                            <?php echo $this->_tpl_vars['item']->r_address; ?>

                        </div>

                    
                    </td>
                    <td><?php echo $this->_tpl_vars['item']->sender; ?>
</td>
                    <td><?php if ($this->_tpl_vars['item']->status == 1): ?>已打印<?php else: ?>未打印<?php endif; ?></td>
                    <td><?php echo $this->_tpl_vars['item']->remark; ?>
</td>

                    <td class="tab_editor">
                        <div class="hover_a" onclick="edit(<?php echo $this->_tpl_vars['item']->id; ?>
)" title="编辑" style="border: none!important;">
    ...
    <div style="position: fixed;bottom: 0;background-color: #fff;width: 98%;">
        ...
        <div style="margin-left: 19px;float: left;padding-top: 24px;">
            ...
            <select name="print_type" class="select" id="print_type" style="width: 108px;height: 31px;vertical-align: middle;">
                <?php $_from = $this->_tpl_vars['tpl']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['f1'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['f1']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['item']):
        $this->_foreach['f1']['iteration']++;
?>
                <option value="<?php echo $this->_tpl_vars['item']->id; ?>
" data-ename="<?php echo $this->_tpl_vars['item']->e_name; ?>
" <?php if ($this->_tpl_vars['item']->id == 1): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['item']->name; ?>
</option>
                <?php endforeach; endif; unset($_from); ?>
            </select>
        </div>
...
unset($_smarty_tpl_vars);
 ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "./templateEditModel.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<?php echo '
