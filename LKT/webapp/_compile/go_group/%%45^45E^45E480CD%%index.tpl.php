<?php /* Smarty version 2.6.31, created on 2019-12-30 10:50:14
...
<nav class="breadcrumb" style="font-size: 16px;"><span class="c-gray en"></span><i class="Hui-iconfont">&#xe67f;</i>
    ...
    <?php if ($this->_tpl_vars['type'] == 'record'): ?>
        <span class="c-gray en">&gt;</span>
        开团记录列表
    <?php elseif ($this->_tpl_vars['type'] == 'canrecord'): ?>
        <span class="c-gray en">&gt;</span>
        参团记录列表
    <?php else: ?>
        <span class="c-gray en">&gt;</span>
...
<div class="page-container pd-20 page_absolute">
    <div style="display: flex;flex-direction: row;font-size: 16px;" class="page_bgcolor">
        <div class="status qh <?php if ($this->_tpl_vars['status'] == 0): ?>isclick<?php endif; ?> border-right"
        ...
        <div class="status qh <?php if ($this->_tpl_vars['status'] == 4): ?>isclick<?php endif; ?> border-right"><a
                    href="index.php?module=go_group&action=Index&status=4" onclick="statusclick(4)">开团记录</a></div>
        <div class="status qh <?php if ($this->_tpl_vars['status'] == 5): ?>isclick<?php endif; ?> border-right"><a
                    href="index.php?module=go_group&action=Index&status=5" onclick="statusclick(5)">参团记录</a></div>
        <div class="status qh <?php if ($this->_tpl_vars['status'] == 6): ?>isclick<?php endif; ?>" style="border-radius: 0px 2px 2px 0px !important;"><a
                    href="index.php?module=go_group&action=Config" onclick="statusclick(5)">拼团设置</a></div>
    </div>
    <div class="page_h16"></div>
    <div class="text-c">
        <?php if ($this->_tpl_vars['type'] == 'record' || $this->_tpl_vars['type'] == 'canrecord'): ?>
...
" id="" placeholder="请输入商品名称"
                       style="width:200px" class="input-text">
                <input type="text" name="username" size='8' value="<?php echo $this->_tpl_vars['username']; ?>
" id="" placeholder="请输入会员名称"
                       style="width:200px" class="input-text">

                <?php if ($this->_tpl_vars['type'] == 'record'): ?>
                    <select style="width: 200px;margin-right: 5px;" name="group_status" class="sel_status">
                        <option value="#">请选择拼团状态</option>
                        <option value="1" <?php if ($this->_tpl_vars['group_status'] == '1'): ?>selected<?php endif; ?>>进行中</option>
                        <option value="2" <?php if ($this->_tpl_vars['group_status'] == '2'): ?>selected<?php endif; ?>>已完成</option>
                        <option value="3" <?php if ($this->_tpl_vars['group_status'] == '3'): ?>selected<?php endif; ?>>失败</option>
                    </select>
                    <select style="width: 200px;margin-right: 5px;" name="group_num" class="sel_status" id="group_num">
                        <option value="#">请选择拼团类型</option>
                        <?php $_from = $this->_tpl_vars['man_arr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['item']):
?>
                        <option value="<?php echo $this->_tpl_vars['item']; ?>
" <?php if ($this->_tpl_vars['group_num'] == $this->_tpl_vars['item']): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['item']; ?>
人团</option>
...
" id="" placeholder="请输入商品名称"
                ...
                <select style="background: #fff;width:200px;" class="sel_status" name="gstatus">
                    ...
                    <option value="2" <?php if ($this->_tpl_vars['gstatus'] == '2'): ?>selected<?php endif; ?>>进行中</option>
                    <option value="1" <?php if ($this->_tpl_vars['gstatus'] == '1'): ?>selected<?php endif; ?>>未开始</option>
                    <option value="3" <?php if ($this->_tpl_vars['gstatus'] == '3'): ?>selected<?php endif; ?>>结束</option>
                </select>
                        ...
                        <td style="display: flex;align-items: center;border: none;">
                            <div style="width: 60px;height: 60px;">
                                <?php if ($this->_tpl_vars['item']->imgurl != ''): ?>
                                    <img onclick="pimg(this)" style="width: 60px;height: 60px;" src="<?php echo $this->_tpl_vars['item']->imgurl; ?>
">
                                <?php else: ?>
                                    <span>暂无图片</span>
                                <?php endif; ?>
                            </div>
                            <div title="<?php echo $this->_tpl_vars['item']->p_name; ?>
"
                                 style="height: 60px; overflow: hidden;white-space: nowrap;text-overflow: ellipsis;width:120px;line-height: 60px;">
                        ...
                        <td>
                            <?php echo $this->_tpl_vars['item']->groupman; ?>
人团
                        </td>
                        <td>￥<?php echo $this->_tpl_vars['item']->price; ?>
 </td>
                        <td>￥<?php echo $this->_tpl_vars['item']->openmoney; ?>
 </td>
                        <td>￥<?php echo $this->_tpl_vars['item']->canmoney; ?>
 </td>
                        <td>
                            开始时间：<?php echo $this->_tpl_vars['item']->start_time; ?>

                            <br/>
                            结束时间：<?php echo $this->_tpl_vars['item']->end_time; ?>

                        </td>
                        <td><?php echo $this->_tpl_vars['item']->user_name; ?>
</td>
                        <td>
                            <?php if ($this->_tpl_vars['item']->ptstatus == 1): ?>
                                <span style="color: orange;">拼团中</span>
                            <?php elseif ($this->_tpl_vars['item']->ptstatus == 3): ?>
                                <span style="color: red;">失败</span>
                            <?php elseif ($this->_tpl_vars['item']->ptstatus == 2): ?>
                        ...
                        <td class="tab_editor">
                            <a href="index.php?module=go_group&action=Canrecord&ptcode=<?php echo $this->_tpl_vars['item']->ptcode; ?>
" style="width: 80%;">查看详情</a>
                                ...
                                <div style="width: 60px;height: 60px;">
                                    <?php if ($this->_tpl_vars['item']->imgurl != ''): ?>
                                        <img onclick="pimg(this)" style="width: 60px;height: 60px;"
                                             src="<?php echo $this->_tpl_vars['item']->imgurl; ?>
">
                                    <?php else: ?>
                                        <span>暂无图片</span>
                                    <?php endif; ?>
                                </div>
                                <div title="<?php echo $this->_tpl_vars['item']->product_title; ?>
"
                        ...
                        <td> <?php echo $this->_tpl_vars['item']->groupman; ?>
人团</td>
                        <td>￥<?php echo $this->_tpl_vars['item']->price; ?>
 </td>
                        <td>￥<?php echo $this->_tpl_vars['item']->canmoney; ?>
                        ...
                        <td>
                            <div>开团时间：<?php echo $this->_tpl_vars['item']->add_time; ?>
</div>
                            <div>结束时间：<?php echo $this->_tpl_vars['item']->pt_end_time; ?>
</div>
                        </td>
                    </tr>
                <?php endforeach; endif; unset($_from); ?>
                    ...
                    <tr class="text-c tab_td">
                        <td>
                            <input type="checkbox" class="inputC input_agreement_protocol"
                                   id="<?php echo $this->_tpl_vars['item']->product_id; ?>
-<?php echo $this->_tpl_vars['item']->activity_no; ?>
-<?php echo $this->_tpl_vars['item']->g_status; ?>
" name="id[]"
                                   value="<?php echo $this->_tpl_vars['item']->product_id; ?>
" data-g_status="<?php echo $this->_tpl_vars['item']->g_status; ?>
"
                                   style="position: absolute;" onclick="onshelves()">
                            <label for="<?php echo $this->_tpl_vars['item']->product_id; ?>
-<?php echo $this->_tpl_vars['item']->activity_no; ?>
-<?php echo $this->_tpl_vars['item']->g_status; ?>
"></label>
                        </td>
                        <td>
                            ...
                            <div style="display: flex;padding: 0 10px;">
                                <?php if ($this->_tpl_vars['item']->g_status == 1): ?>
                                    <span style="color: orange;">未开始</span>
                                <?php elseif ($this->_tpl_vars['item']->g_status == 2): ?>
...
元
                        ...
                        <td>
                            <p style="margin: 0 !important;"><?php echo $this->_tpl_vars['item']->min_man; ?>
人团</p>
                            <p style="margin: 0 !important;"><?php echo $this->_tpl_vars['item']->min_price; ?>
元</p>
                        </td>
                        <td><?php echo $this->_tpl_vars['item']->num; ?>
</td>
                        <td><?php echo $this->_tpl_vars['item']->actime; ?>
</td>
                        <td style="text-align: center;">
                            <?php if ($this->_tpl_vars['item']->is_show == 0): ?>
                                <span>否</span>
                            <?php else: ?>
                                <span>是</span>
                            <?php endif; ?>
                        ...
                        <td class="tab_editor">
                            <div class="tab_block">
                                <div style="display: flex; ">
                                    <?php if ($this->_tpl_vars['item']->g_status == 3): ?>
                                    ...
                                    <?php else: ?>
                                        <a href="index.php?module=go_group&action=Modify&id=<?php echo $this->_tpl_vars['item']->product_id; ?>
&activity_no=<?php echo $this->_tpl_vars['item']->activity_no; ?>
"
                                           title="<?php if ($this->_tpl_vars['item']->g_status == 2 && $this->_tpl_vars['item']->is_show == 1): ?>查看<?php else: ?>编辑<?php endif; ?>">
                                            <img src="images/icon1/ck.png"/>&nbsp;<?php if ($this->_tpl_vars['item']->g_status == 2 && $this->_tpl_vars['item']->is_show == 1): ?>查看<?php else: ?>编辑<?php endif; ?>
                                        </a>
                                    <?php endif; ?>
                                    <?php if ($this->_tpl_vars['item']->is_show == 0): ?>
                                        <a onclick="aj('<?php echo $this->_tpl_vars['item']->product_id; ?>
','1','<?php echo $this->_tpl_vars['item']->activity_no; ?>
')"
                                    ...
                                    <?php else: ?>
                                        <a onclick="aj('<?php echo $this->_tpl_vars['item']->product_id; ?>
','0','<?php echo $this->_tpl_vars['item']->activity_no; ?>
')"
                                           href="jdisplay: flex;align-items: center;avascript:void(0);" title="隐藏">
                                            <img src="images/icon1/sj_g.png"/>&nbsp;隐藏
                                        </a>
                                    <?php endif; ?>
                                    <a onclick="go_details('<?php echo $this->_tpl_vars['item']->product_title; ?>
','<?php echo $this->_tpl_vars['item']->activity_no; ?>
')" href="javascript:void(0);"
                                ...
                                <div style="display: flex; ">
                                    <?php if ($this->_tpl_vars['item']->g_status == 1 || $this->_tpl_vars['item']->g_status == 3): ?>
                                        <?php if ($this->_tpl_vars['item']->g_status == 1 && $this->_tpl_vars['item']->no_have == 1): ?>
                                                                                        <a onclick="aj1(<?php echo $this->_tpl_vars['item']->product_id; ?>
,'2','<?php echo $this->_tpl_vars['item']->starttime; ?>
','<?php echo $this->_tpl_vars['item']->endtime; ?>
','<?php echo $this->_tpl_vars['item']->status; ?>
','<?php echo $this->_tpl_vars['item']->activity_no; ?>
','<?php echo $this->_tpl_vars['item']->is_copy; ?>
')"
                                    ...
                                    <?php else: ?>
                                        <a onclick="aj1(<?php echo $this->_tpl_vars['item']->product_id; ?>
,'3','<?php echo $this->_tpl_vars['item']->starttime; ?>
','<?php echo $this->_tpl_vars['item']->endtime; ?>
','<?php echo $this->_tpl_vars['item']->status; ?>
','<?php echo $this->_tpl_vars['item']->activity_no; ?>
')"
                                    ...
                                    <?php endif; ?>
                                    <?php if ($this->_tpl_vars['item']->g_status != 2): ?>
                                        <a title="删除" href="javascript:;"
                                           onclick="delgrouppro1(this,<?php echo $this->_tpl_vars['item']->product_id; ?>
,'index.php?module=go_group&action=Member&m=delpro&activity_no=<?php echo $this->_tpl_vars['item']->activity_no; ?>
&id=')"
                                           class="ml-5" data-g_status="<?php echo $this->_tpl_vars['item']->g_status; ?>
">
                                    ...
                                    <?php endif; ?>
                                    <a onclick="go_copy('<?php echo $this->_tpl_vars['item']->activity_no; ?>
')" href="javascript:void(0);" title="复制">
