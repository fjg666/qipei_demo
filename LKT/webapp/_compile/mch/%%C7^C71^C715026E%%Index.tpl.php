<?php /* Smarty version 2.6.31, created on 2019-12-20 16:57:34
    ...
    <div class="text-c">
        <form name="form1" action="index.php" method="get">
            ...
            <select name="is_open" id="is_open" class="select" style="width: 130px;vertical-align: middle;">
                <option <?php if ($this->_tpl_vars['is_open'] == ''): ?>selected="selected"<?php endif; ?> value="">请选择营业状态</option>
                <option <?php if ($this->_tpl_vars['is_open'] == '0'): ?>selected="selected"<?php endif; ?> value="0">未营业</option>
                <option <?php if ($this->_tpl_vars['is_open'] == '1'): ?>selected="selected"<?php endif; ?> value="1">营业</option>
            </select>
...
" class="tab_pic">
                    ...
                    <td style="font-weight:400;color:rgba(65,70,88,1);font-size: 14px;"><?php echo $this->_tpl_vars['item']->account_money; ?>
</td>
                    <td style="font-weight:400;color:rgba(65,70,88,1);font-size: 14px;"><?php echo $this->_tpl_vars['item']->review_time; ?>
</td>
                    <td class="tab_three">
...
" title="查看">
                        ...
                        <?php if ($this->_tpl_vars['button'][6] == 1): ?>
                            <a href="index.php?module=mch&action=Modify&id=<?php echo $this->_tpl_vars['item']->id; ?>
" title="修改">
...
,'index.php?module=mch&action=Del&id=')">
    ...
    <div class="tab_footer tb-tab"><?php echo $this->_tpl_vars['pages_show']; ?>
</div>
</div>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
