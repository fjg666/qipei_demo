<?php /* Smarty version 2.6.31, created on 2019-12-30 15:10:43
...
" id="" placeholder="请输入商品名称" class="input-text query_inputs" style="border: 1px solid rgb(213, 219, 232)!important;">
            <select name="status" class="select query_select" style="background-color: #ffffff">
                <option value="" >请选择活动状态</option>
                <option value="0" <?php if ($this->_tpl_vars['status'] === '0'): ?>selected="selected"<?php endif; ?> >未开始</option>
                <option value="1" <?php if ($this->_tpl_vars['status'] == 1): ?>selected="selected"<?php endif; ?>>竞拍中</option>
                <option value="2" <?php if ($this->_tpl_vars['status'] == 2): ?>selected="selected"<?php endif; ?>> 已结束 </option>
           </select>
...
"></label>
                            ...
                            <td style="display: flex;justify-content: left;">
                                <div style="display: flex; position: relative;flex-direction: column;justify-content: center;width: 70px;height: 88px;">
                                    <img onclick="pimg(this)" class="pro-img" style="width: 60px;height:60px;" src="<?php echo $this->_tpl_vars['item']->image; ?>
">
                                </div>
                                <div style="width: 100px;padding-top: 20px;">
                                    <p align="left" style="width: 110px;overflow: hidden;white-space: nowrap;text-overflow: ellipsis;margin-bottom: 0px;" title="<?php echo $this->_tpl_vars['item']->title; ?>
"><?php echo $this->_tpl_vars['item']->title; ?>
                            ...
                            <td class="tab_time">开始时间：<?php echo $this->_tpl_vars['item']->starttime; ?>
<br />结束时间：<?php echo $this->_tpl_vars['item']->endtime; ?>
</td>
                            <td>￥<?php echo $this->_tpl_vars['item']->price; ?>
</td>
                            <td>￥<?php echo $this->_tpl_vars['item']->current_price; ?>
</td>
...
)" is_show="<?php echo $this->_tpl_vars['item']->is_show; ?>
" style="margin-left: 0;<?php if ($this->_tpl_vars['item']->is_show == 1): ?>background-color:#2890FF;<?php else: ?>background-color: #ccc;<?php endif; ?>">
...
" style="<?php if ($this->_tpl_vars['item']->is_show == 1): ?>left:30px;<?php else: ?>left:0px;<?php endif; ?>"></div>
                            ...
                            <td class="tab_editor" >
                               <div style="display: flex;justify-content: center;align-items: center;">
								   <a style="text-decoration:none" class="ml-7" href="index.php?module=auction&action=Record&id=<?php echo $this->_tpl_vars['item']->id; ?>
" title="详情">
								       <img src="images/icon1/ck.png"/>&nbsp;详情
								   </a> 
								   <?php if ($this->_tpl_vars['item']->status == 0): ?>
								        <a style="text-decoration:none" class="ml-7" onclick="aj(<?php echo $this->_tpl_vars['item']->id; ?>
)" href="javascript:void(0);" title="开始">   
								               <img src="images/icon1/sj_g.png"/>&nbsp;开始
								        </a> 
								   <?php endif; ?>  
								   <?php if ($this->_tpl_vars['item']->status == 1): ?>
								        <a style="text-decoration:none" class="ml-7" onclick="confirm('确认停止该活动的商品活动？',<?php echo $this->_tpl_vars['item']->id; ?>
,'index.php?module=auction&action=Change&m=siwtch&id=','停止')" href="javascript:void(0);" title="停止">
								               <img src="images/icon1/xj.png"/>&nbsp;停止
								        </a>  
								   <?php endif; ?>
								    <?php if ($this->_tpl_vars['item']->status == 0 || ( $this->_tpl_vars['item']->status == 1 && $this->_tpl_vars['item']->is_show == 0 )): ?>
								        <a style="text-decoration:none" class="ml-7" onclick="my_warn(<?php echo $this->_tpl_vars['item']->status; ?>
)" href="index.php?module=auction&action=Modify&id=<?php echo $this->_tpl_vars['item']->id; ?>
" title="编辑">
								          <img src="images/icon1/xg.png"/>&nbsp;编辑
								        </a> 
								    <?php endif; ?>
								   <?php if ($this->_tpl_vars['item']->status != 1): ?>
								    <a title="删除" href="javascript:;" onclick="confirm('确认删除该竞拍活动商品记录么？',<?php echo $this->_tpl_vars['item']->id; ?>
,'index.php?module=auction&action=Change&m=del&id=','删除')" class="ml-7" >
