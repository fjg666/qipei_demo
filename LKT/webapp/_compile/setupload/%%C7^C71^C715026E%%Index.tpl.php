<?php /* Smarty version 2.6.31, created on 2019-12-20 15:35:23
    ...
    <form name="form1" class="form form-horizontal" style="padding: 60px;padding-top: 40px;">
        <div class="row cl" style="display: flex; align-items: center;margin-top: 0;padding: 0;">
            ...
            <div class="formControls col-xs-8 col-sm-6">
                <input class="radio" type="radio" name="upserver" value="local" <?php if ($this->_tpl_vars['upserver'] == 1): ?>checked<?php endif; ?>>本地
                <input class="radio" type="radio" name="upserver" value="OSS" <?php if ($this->_tpl_vars['upserver'] == 2): ?>checked<?php endif; ?> style="margin-left:20px;">阿里云
                                            </div>
        </div>
        ...
        <div id="local" name="seriver" class="divhide form_content">
            ...
            <div class="row cl" style="margin-top: 30px;">
                ...
                <div class="formControls col-4">
                    <input type="text" class="input-text" value="<?php echo $this->_tpl_vars['local']['uploadImg_domain']; ?>
" placeholder="" id="" name="uploadImg_domain">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-3"><span class="c-red">*</span>图片上传位置</label>
                <div class="formControls col-4">
                    <input type="text" class="input-text" value="<?php echo $this->_tpl_vars['local']['uploadImg']; ?>
" placeholder="" id="" name="uploadImg">
                </div>
            </div>
        </div>
        ...
        <div id="OSS" name="seriver" class="divhide form_content">
            ...
            <div class="row cl" style="margin-top: 30px;">
                ...
                <div class="formControls col-4">
                    <input type="text" class="input-text" value="<?php echo $this->_tpl_vars['oss']['Bucket']; ?>
" placeholder="" id="" name="OSSBucket">
                </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-4">
                    <input type="text" class="input-text" value="<?php echo $this->_tpl_vars['oss']['Endpoint']; ?>
" placeholder="" id="" name="OSSEndpoint">
                </div>
                ...
                <div class="formControls col-2 skin-minimal" style="display: flex; height: 25px; align-items: center;">
                    <div class="radio-box" style="display: flex;align-items: center;padding: 0;">
                        <input name="OSSzidingyi" type="radio" value="0"
                               <?php if ($this->_tpl_vars['oss']['isopenzdy'] == 0): ?>checked="checked"<?php endif; ?> style="width: 14px;height: 14px!important;margin-top: 0;"/>
                        <label for="sex-0">否</label>
                    </div>
                    <div class="radio-box" style="display: flex;align-items: center;padding: 0;margin-left: 20px;">
                        <input name="OSSzidingyi" type="radio" value="1" <?php if ($this->_tpl_vars['oss']['isopenzdy'] == 1): ?>checked="checked"<?php endif; ?> style="width: 14px;height: 14px!important;margin-top: 0;"/>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-4">
                    <input type="text" class="input-text" value="<?php echo $this->_tpl_vars['oss']['AccessKeyID']; ?>
" placeholder="" id="" name="OSSAccessKey">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-3"><span class="c-red">*</span>Access Key Secret</label>
                <div class="formControls col-4">
                    <input type="text" class="input-text" value="<?php echo $this->_tpl_vars['oss']['AccessKeySecret']; ?>
" placeholder="" id="" name="OSSAccessSecret">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-3">图片样式接口（选填）</label>
                <div class="formControls col-4">
                    <input type="text" class="input-text" value="<?php echo $this->_tpl_vars['oss']['imagestyle']; ?>
" placeholder="" id="" name="OSSimgstyleapi">
                </div>
            </div>
        </div>
        ...
        <div id="tenxun" name="seriver" class="divhide form_content">
            ...
            <div class="row cl" style="margin-top: 30px;">
                <label class="form-label col-3"><span class="c-red">*</span>存储空间名称（Bucket）</label>
                <div class="formControls col-4">
                    <input type="text" class="input-text" value="<?php echo $this->_tpl_vars['tenxun']['Bucket']; ?>
" placeholder="" id="" name="tenxunBucket">
                </div>
                <div style="color:#666;">请设置存储空间为公共读</div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-4">
                    <input type="text" class="input-text" value="<?php echo $this->_tpl_vars['tenxun']['Endpoint']; ?>
" placeholder="" id="" name="tenxunEndpoint">
                </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-4">
                    <input type="text" class="input-text" value="<?php echo $this->_tpl_vars['tenxun']['zidingyi']; ?>
" placeholder="" id="" name="tenxunzidingyi">
                </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-4">
                    <input type="text" class="input-text" value="<?php echo $this->_tpl_vars['tenxun']['SecretId']; ?>
" placeholder="" id="" name="tenxunAccessKey">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-3">SecretKey</label>
                <div class="formControls col-4">
                    <input type="text" class="input-text" value="<?php echo $this->_tpl_vars['tenxun']['SecretKey']; ?>
" placeholder="" id="" name="tenxunAccessSecret">
                </div>
            </div>
        ...
        <div id="qiniu" name="seriver" class="divhide form_content">
            ...
            <div class="row cl" style="margin-top: 30px;">
                <label class="form-label col-3"><span class="c-red">*</span>存储空间名称（Bucket）</label>
                <div class="formControls col-4">
                    <input type="text" class="input-text" value="<?php echo $this->_tpl_vars['qiniu']['Bucket']; ?>
" placeholder="" id="" name="qiniuBucket">
                </div>
                <div style="color:#666;">请设置存储空间为公共读</div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-4">
                    <input type="text" class="input-text" value="<?php echo $this->_tpl_vars['qiniu']['Endpoint']; ?>
" placeholder="" id="" name="qiniuEndpoint">
                </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-4">
                    <input type="text" class="input-text" value="<?php echo $this->_tpl_vars['qiniu']['AccessKey']; ?>
" placeholder="" id="" name="qiniuAccessKey">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-3">SecretKey（SK）</label>
                <div class="formControls col-4">
                    <input type="text" class="input-text" value="<?php echo $this->_tpl_vars['qiniu']['SecretKey']; ?>
" placeholder="" id="" name="qiniuAccessSecret">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-3">图片样式接口（选填）</label>
                <div class="formControls col-4">
                    <input type="text" class="input-text" value="<?php echo $this->_tpl_vars['qiniu']['imagestyle']; ?>
" placeholder="" id="" name="qiniuimgstyleapi">
                </div>
            </div>
        </div>
...
<?php echo '
    <script>
        var servertype = \''; ?>
<?php echo $this->_tpl_vars['upserver']; ?>
<?php echo '\';
