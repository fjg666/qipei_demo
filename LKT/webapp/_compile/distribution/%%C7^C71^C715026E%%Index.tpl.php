<?php /* Smarty version 2.6.31, created on 2019-12-20 16:57:37
...
" id="user_name" placeholder="请输入分销商名称/手机号码" style="width:200px" class="input-text">
            <input type="text" name="r_name" size='8' value="<?php echo $this->_tpl_vars['r_name']; ?>
" id="r_name" placeholder="请输入推荐人名称" style="width:200px" class="input-text">

            <select name="level" id="level" class="select" style="width: 150px;vertical-align: middle;">
                <option value="">请选择分销商等级</option>
                <?php $_from = $this->_tpl_vars['distributors']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['f1'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['f1']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['item']):
        $this->_foreach['f1']['iteration']++;
?>
                    <option <?php if ($this->_tpl_vars['level'] == $this->_tpl_vars['item']->id): ?>selected="selected"<?php endif; ?>
...
" placeholder="请输入结束时间" id="enddate" name="enddate"
                       style="width:150px;">
            </div>
...
?>
                <tr class="text-c tab_td">
                    ...
                    <td><?php echo $this->_tpl_vars['item']->r_name; ?>
</td>
                    ...
                    <td><?php if ($this->_tpl_vars['item']->s_dengjiname): ?><?php echo $this->_tpl_vars['item']->s_dengjiname; ?>
<?php else: ?>默认等级<?php endif; ?></td>
                    <td><?php echo $this->_tpl_vars['item']->yjyj; ?>
</td>
                    <td><?php echo $this->_tpl_vars['item']->dkyj; ?>
</td>
                    <td><?php echo $this->_tpl_vars['item']->commission; ?>
</td>
                    <td><?php echo $this->_tpl_vars['item']->add_date; ?>
</td>
                    <td style="width: 200px;">
                        <a style="text-decoration:none;" class="ml-7" href="index.php?module=distribution&action=See&id=<?php echo $this->_tpl_vars['item']->user_id; ?>
" title="查看详细">
                        ...
                        <a style="text-decoration:none;" class="ml-5" title="编辑"
                           href="index.php?module=distribution&action=Edit&id=<?php echo $this->_tpl_vars['item']->user_id; ?>
">
                            <div style="align-items: center;font-size: 12px;display: flex;">
                                <div style="margin:0 auto;;display: flex;align-items: center;">
                        ...
                        <a style="text-decoration:none;" class="ml-7" href="index.php?module=distribution&action=Lower&id=<?php echo $this->_tpl_vars['item']->user_id; ?>
" title="查看下级">
                            <div style="align-items: center;font-size: 12px;display: flex;">
                                <div style="margin:0 auto;;display: flex;align-items: center;">
                        ...
                        <a style="text-decoration:none;display: none;" class="ml-5" href="javascript:void(0);"
                           onclick="confirm('删除分销商将导致此用户无法使用分销功能，请谨慎操作！',<?php echo $this->_tpl_vars['item']->id; ?>
,'index.php?module=distribution&action=Del&id=','删除')">
                            <div style="align-items: center;font-size: 12px;display: flex;">
                                <div style="margin:0 auto;;display: flex;align-items: center;">
