<?php /* Smarty version 2.6.31, created on 2019-12-30 11:14:03
...
"
                ...
                <tr>
                    ...
                    <td>
                        <?php echo $this->_tpl_vars['user'][0]->user_id; ?>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo $this->_tpl_vars['user'][0]->user_name; ?>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo $this->_tpl_vars['user'][0]->zhanghao; ?>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo $this->_tpl_vars['user'][0]->grade; ?>
                ...
                <tr>
                    ...
                    <td>
                        <?php if ($this->_tpl_vars['user'][0]->grade == '普通会员'): ?>
                            无
                        <?php else: ?>
                            <?php echo $this->_tpl_vars['user'][0]->grade_end; ?>
                ...
                <tr>
                    ...
                    <td>
                       <?php echo $this->_tpl_vars['user'][0]->mobile; ?>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo $this->_tpl_vars['user'][0]->mima_1; ?>
                ...
                <tr>
                    ...
                    <td>
                       ￥<?php echo $this->_tpl_vars['user'][0]->money; ?>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo $this->_tpl_vars['user'][0]->score; ?>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo $this->_tpl_vars['user'][0]->birthday; ?>
                ...
                <tr>
                    ...
                    <td>
                      <?php echo $this->_tpl_vars['user'][0]->z_num; ?>
                ...
                <tr>
                    ...
                    <td>
                      ￥<?php echo $this->_tpl_vars['user'][0]->z_price; ?>
                ...
                <tr>
                    ...
                    <td>
                      <?php echo $this->_tpl_vars['user'][0]->share_num; ?>
                ...
                <tr>
                    ...
                    <td>
                      <?php echo $this->_tpl_vars['user'][0]->login_num; ?>
                ...
                <tr>
                    ...
                    <td>
                        <span><?php echo $this->_tpl_vars['user'][0]->clientid; ?>
</span>
                    </td>
                </tr>
                <!-- <tr>
                    ...
                    <td>
                        <?php if ($this->_tpl_vars['user'][0]->is_lock == '1'): ?>
