<?php /* Smarty version 2.6.31, created on 2019-12-30 19:27:37
                  ...
                  <div class="formInputSD upload-group multiple" style="display: inline-flex;">
                    <div style="display: flex;">
                        <div>
                                ...
                                <img src="<?php echo $this->_tpl_vars['wx_headimgurl']; ?>
" class="upload-preview-img" style="margin-top: -10px;width: 60px;height: 60px;border-radius: 50%;">
                                <input type="hidden" name="wx_headimgurl" class="file-item-input" value="<?php echo $this->_tpl_vars['wx_headimgurl']; ?>
">
              ...
              <div class="row cl" style="margin-top: 10px;">
                  ...
                  <div class="formControls col-xs-8" >
                      <input type="text" style="width: 180px!important;" name="wx_name" value="<?php echo $this->_tpl_vars['wx_name']; ?>
" class="input-text" placeholder="请输入昵称">
                  </div>
              </div>
              <div class="row cl" style="margin-top: 0px;">
                ...
                <div class="form_new_r" style="margin-top: 1px;">
                 <select name="grade" style="margin-left: 0px!important;width: 180px;">
                  <?php echo $this->_tpl_vars['str_grade']; ?>

                 </select>
                </div>
              </div>
              <div class="row cl method" style="margin-top: 0px;<?php if ($this->_tpl_vars['str_method'] == ''): ?>display: none;<?php endif; ?>" >
                ...
                <div class="form_new_r" style="margin-top: 1px;">
                 <select name="method" style="margin-left: 0px!important;width: 180px;">
                   <?php echo $this->_tpl_vars['str_method']; ?>
...
<script type="text/javascript">
 ...
 var str_method = '<?php echo $this->_tpl_vars['str_method']; ?>
'
 <?php echo ' 
