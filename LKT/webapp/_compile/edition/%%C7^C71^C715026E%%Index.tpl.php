<?php /* Smarty version 2.6.31, created on 2019-12-27 15:24:05
        ...
        <div id="tab-system" class="HuiTab">
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-6">
                    <input type="text" name="appname" value="<?php echo $this->_tpl_vars['appname']; ?>
" class="input-text">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-6">
                    <input type="text" name="edition" value="<?php echo $this->_tpl_vars['edition']; ?>
" class="input-text">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-6">
                    <input type="text" name="android_url" value="<?php echo $this->_tpl_vars['android_url']; ?>
" class="input-text" >
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-6">
                    <input type="text" name="ios_url" value="<?php echo $this->_tpl_vars['ios_url']; ?>
" class="input-text" >
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-8 skin-minimal">
                    <div class="form_new_r form_yes" style="width: 90%;">
                        <div class="ra1" style="width: 10%!important;">
                            <input style="display: none;" class="inputC1" type="radio" name="type" id="type0" value="0" <?php if ($this->_tpl_vars['type'] == 0): ?>checked="checked"<?php endif; ?>>
                            <label for="type0">是</label>
                        </div>
                        <div class="ra1" style="width: 10%!important;">
                            <input style="display: none;" class="inputC1" type="radio" name="type" id="type1" value="1" <?php if ($this->_tpl_vars['type'] == 1): ?>checked="checked"<?php endif; ?>>
