<?php /* Smarty version 2.6.31, created on 2019-12-20 16:57:39
...
"><?php echo $this->_tpl_vars['item']->product_title; ?>
                            ...
                            <td><?php echo $this->_tpl_vars['item']->integral; ?>
</td>
                            <td><?php echo $this->_tpl_vars['item']->money; ?>
</td>
                            <td <?php if ($this->_tpl_vars['item']->inventory == 0): ?>style="color: red;"<?php endif; ?>><?php echo $this->_tpl_vars['item']->num; ?>
</td>
                            <td class="tab_editor" >
                                <a href="index.php?module=integral&action=Addpro&id=<?php echo $this->_tpl_vars['item']->id; ?>
" title="编辑">
                                    <img src="images/icon1/xg.png"/>&nbsp;编辑
                                </a>

                                <a onclick="top1('<?php echo $this->_tpl_vars['item']->id; ?>
')" href="javascript:void(0);" title="置顶">
                                    <img src="images/icon1/sj_g.png"/>&nbsp;置顶
                                </a>

                                <?php if ($this->_tpl_vars['item']->candel == 1): ?>
