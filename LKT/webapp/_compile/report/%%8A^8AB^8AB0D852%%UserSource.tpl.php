<?php /* Smarty version 2.6.31, created on 2019-12-31 16:23:53
         compiled from UserSource.tpl */ ?>
...
" placeholder="请输入结束时间"  autocomplete="off" id="enddate" name="enddate" style="width:150px;">
     ...
     <div class="page_h16"></div>
    <input type="hidden" name="my_wx"  value="<?php echo $this->_tpl_vars['num_wx']; ?>
">
    <input type="hidden" name="my_app" value="<?php echo $this->_tpl_vars['num_app']; ?>
">
