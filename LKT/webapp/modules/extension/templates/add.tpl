        ...
        <script>
            ...
            function check() {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    dataType: "json",
                    url: 'index.php?module=extension&action=add',
                                    ...
                                    <div class='panel-body'>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9 col-xs-12">
                                                ...
                                                <label class="radio-inline">
                                                    <input type="radio" name="type" value="2"/> 红包海报
                                                </label>
                                                <label class="radio-inline">
                                                    <input type="radio" checked="checked" name="type" value="3"/> 商品海报
                                                </label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="type" value="4"/> 分销海报
                                                </label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="type" value="5"/> 邀请海报
                                                </label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="type" value="6"/> 竞拍海报
                                                </label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    $('#bgset').find('button:first').click(function () {
                                        ...
                                        bgtimer = setInterval(function () {
                                            ...
                                            if (oldbg != bg && bg != '') {
                                                ...
                                                var first = $('#poster .drag:first');
                                                if (first.length > 0) {
                                                    bgh.insertBefore(first); // 在每个first元素之前插入 bgh
                                                } else {
                                                    $('#poster').append(bgh); // 在每个 id='poster' 结尾插入内容
                                                }
                                                oldbg = bg;
                                                clearInterval(bgtimer);
                                            }
