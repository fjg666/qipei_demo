<div id="modal-pass" class="modal felxx" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="z-index: 9999;">
              ...
              <form name="form1" id="form1" class="form form-horizontal" method="post"   enctype="multipart/form-data" >
                  ...
                  <div class="row">
                    <div class=" col-xs-4 col-sm-6">
                      <div class="row">
                        <label class=" col-xs-4 col-sm-4">快递/物流公司：</label>
                        <div class="col-xs-8 col-sm-8 card-left">
                          <select id="selectid" class="select" size="1" name="tempname">
                            <option value="" selected>请选择快递/物流公司</option>
                      ...
                      <div class="row">
                        <label class=" col-xs-4 col-sm-4">模板名称：</label>
                        <div class="col-xs-8 col-sm-8 card-left">
                          <select id="selectid" class="select" size="1" name="tempname">
                    ...
                    <div class="col-xs-4 col-sm-5 card-right">
                      <div class="right-effect" style="width: 220px;height:352px;">
