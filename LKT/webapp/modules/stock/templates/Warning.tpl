        ...
        <table class="table-border tab_content">
            ...
            {foreach from=$list item=item name=f1}
                <tr class="text-c tab_td">
                    ...
                    <td class="tab_dat">
                        {if $button[5] == 1}
                            <a style="text-decoration:none;" class="ml-5" href="index.php?module=stock&action=Seewarning&id={$item->id}&pid={$item->pid}" title="查看预警记录" >
                                <img src="images/icon1/ck.png"/>&nbsp;预警记录
                            </a>
                        {/if}
                        {if $button[4] == 1}
                            <a style="text-decoration:none" class="ml-5" onclick="add('index.php?module=stock&action=Add','{$item->id}','{$item->pid}',2)" >
