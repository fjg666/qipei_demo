...
class IndexAction extends Action {
    ...
    public function getDefaultView() {
        ...
        $button[5] = $JurisdictionAction->Jurisdiction($store_id,$admin_name,$admin_type1,'index.php?module=stock&action=See');
        ...
        $url = "index.php?module=stock&action=Index&pagesize=".urlencode($pagesize)."&product_number=".urlencode($product_number)."&product_title=".urlencode($product_title);
