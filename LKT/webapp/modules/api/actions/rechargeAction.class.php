...
class rechargeAction extends Apimiddle {
...
//        }
    ...
    public function recharge(){  
        ...
        // 查询余额参数表
        $sql = "select cz_multiple from lkt_finance_config where store_id = '$store_id'";
        $r = $db->select($sql);
        if($r){
        ...
        // 查询系统配置
        $ss = "select * from lkt_config where store_id = '$store_id'";
        $rs = $db->select($ss);
        ...
        $notify_url =   $rs[0]->uploadImg_domain.'/notify_url.php';
        $openid =       $openid; // 微信id
