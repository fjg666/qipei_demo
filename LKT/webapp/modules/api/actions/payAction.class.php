...
class payAction extends Apimiddle {
    ...
    public function pay(){  
        ...
        $out_trade_no = trim($request->getParameter('oid')) ? trim($request->getParameter('oid')):$dingdanhao;
        ...
        require_once(MO_LIB_DIR . '/WxPayPubHelper/'.$rs[0]->mch_id.'_WxPay.pub.config.php');
