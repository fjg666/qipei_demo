...
.ta_btn1{border: 1px solid #2890FF!important;color: #2890FF!important;text-align: center;margin-right: 40px!important;}
...
<body>
<nav class="breadcrumb page_bgcolor" style="margin-top: -22px;">
    ...
    <span class="c-gray en">&gt;</span>
    <span style="color: #414658;">添加分销等级</span>
</nav>
<div class="page-container pd-20 page_absolute">
    ...
    <table class="table table-bg table-hover " style="width: 100%;height:100px;border-radius: 30px;border: 1px solid darkgray;">
      ...
      <div class="formDivSD">
          <div class="formTitleSD">添加分销等级</div>
          <div class="formContentSD">
              ...
              <div class="formListSD">
                  ...
                  <div class="formInputSD">
                      ...
                      <div class="input" id="open_integral">
              ...
              <div class="formListSD">
                  ...
                  <div class="formInputSD">
                      ...
                      <div class="input" id="open_discount">
              ...
              <div class="formListSD">
                  ...
                  <div class="form_new_r form_yes" style="width: 45%;">
                      <div class="ra1" style="width: 100px;">
                          <input style="display: none;" class="inputC1" type="radio" name="price_type" id="radio1" value="0" {if $re02.price_type==0}checked="checked"{/if}>
                          <label for="radio1" class="price_type" data="0" style="margin-left: 0;">百分比</label>
                      </div>
                      <div class="ra1" style="width: 100px;">
                          <input style="display: none;" class="inputC1" type="radio" name="price_type" id="radio2" value="1" {if $re02.price_type==1}checked="checked"{/if}>
                          <label for="radio2" class="price_type" data="1" style="width: 80px!important;">固定金额</label>
                      </div>
                  </div>
              </div>
              <div class="formListSD">
                  <div class="formTextSD"></div>
                  <div class="formInputSD">
                      级差奖，可获得&nbsp<input type="number" name="different" min="0" value="{$re02.different}" class="input-text" ><font class="percent">{if $re02.price_type==0}%{else}元{/if}</font>的佣金收益
                  </div>
              </div>
              <div class="formListSD">
                  <div class="formTextSD"></div>
                  <div class="formInputSD">
                      同级奖，可获得&nbsp<input type="number" name="sibling" min="0" value="{$re02.sibling}" class="input-text"><font class="percent">{if $re02.price_type==0}%{else}元{/if}</font>&nbsp的佣金收益
                  </div>
              </div>
            ...
            <div class="formListSD">
              ...
              <div class="formInputSD">
                <div class="ra1">
                  <input name="onebuy" type="checkbox" id="onebuy_1" value="1" class="inputC" {if isset($re02.levelobj.onebuy)}checked{/if}>
                  <label for="onebuy_1" style="margin-top: -24px;"></label>
                </div>
                <span class="formTextSDD">一次性消费满</span>
                <input type="number" id="onebuy" value="{$re02.levelobj.onebuy}" class="input-text" style="width: 100px;">
            ...
            <div class="formListSD">
              ...
              <div class="formInputSD">
                <div class="ra1">
                  <input name="recomm" type="checkbox" id="recomm_1" value="5" class="inputC" {if isset($re02.levelobj.recomm)}checked{/if}>
                  <label for="recomm_1" style="margin-top: -24px;"></label>
                </div>
                <span class="formTextSDD">推荐</span>
                <input type="number" id="recomm" value="{$re02.levelobj.recomm[0]}" class="input-text" style="width: 100px;">
            ...
            <div class="formListSD">
              ...
              <div class="formInputSD">
                <div class="ra1">
                  <input name="manybuy" type="checkbox" id="manybuy_1" value="2" class="inputC" {if isset($re02.levelobj.manybuy)}checked{/if}>
                  <label for="manybuy_1" style="margin-top: -24px;"></label>
                </div>
                <span class="formTextSDD">累计消费金额满</span>
                <input type="number" id="manybuy" value="{$re02.levelobj.manybuy}" class="input-text" style="width: 100px;">
                <span class="formTextSDD">元</span>
              </div>
            </div>
            ...
            <div class="formListSD">
              ...
              <div class="formInputSD">
                <div class="ra1">
                  <input name="manyyeji" type="checkbox" id="manyyeji_1" value="3" class="inputC" {if isset($re02.levelobj.manyyeji)}checked{/if}>
                  <label for="manyyeji_1" style="margin-top: -24px;"></label>
                </div>
                <span class="formTextSDD">累计业绩金额满</span>
                <input type="number" id="manyyeji" value="{$re02.levelobj.manyyeji[0]}" class="input-text" style="width: 100px;">
                <span class="formTextSDD">元</span>
              </div>
            </div>
            ...
            <div class="formListSD">
              ...
              <div class="formInputSD">
                <div class="ra1">
                  <input name="manypeople" type="checkbox" id="manypeople_1" value="4" class="inputC" {if isset($re02.levelobj.manypeople)}checked{/if}>
                  <label for="manypeople_1" style="margin-top: -24px;"></label>
                </div>
                <span class="formTextSDD">直推人数满</span>
                <input type="number" id="manypeople" value="{$re02.levelobj.manypeople[0]}" class="input-text" style="width: 100px;">
                <span class="formTextSDD">个，团队人数满</span>
                <input type="number" id="manypeople1" value="{$re02.levelobj.manypeople[1]}" class="input-text" style="width: 100px;">
...
document.onkeydown = function (e) {
    ...
    if (Number($('#integrall').val()) == 0) {
        ...
        $('.circle').css('left', '30px'),
            $('.circle').css('background-color', '#fff'),
            $('.circle').parent(".wrap").css('background-color', '#008DEF');
        $("#open_integral").show();
    }
    $('.circle').click(function () {
        ...
        if (left == 0) {
            $(this).css('left', '30px'),
                ...
                $(this).parent(".wrap").css('background-color', '#008DEF');
            $("#open_integral").show();
            status.val(1);
        } else {
            $(this).css('left', '0px'),
    ...
    if (Number($('#discountt').val()) == 0) {
        ...
        $('.circle2').css('left', '30px'),
            $('.circle2').css('background-color', '#fff'),
            $('.circle2').parent(".wrap").css('background-color', '#008DEF');
        $("#open_discount").show();
    }
            ...
            var checklevel = $("input[type=checkbox]:checked");
             ...
             if(check){
                  $.ajax({
                    ...
                    type: "POST",
                    dataType:"json",
                    url:'index.php?module=distribution&action=Distribution_add',
                    data:{s_dengjiname:s_dengjiname,sort:sort,price_type:price_type,integral:integral,discount:discount,zhekou:zhekou,member_proportion:member_proportion,levelobj:levelobj,levelmoney:levelmoney,different:different,sibling:sibling},// 你的formid
                    async: true,
