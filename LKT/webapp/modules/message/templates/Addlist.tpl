    ...
    <form name="form1" id="form1"  class="form form-horizontal" method="post" enctype="multipart/form-data" >
        <div class="row cl">
            ...
            <div class="formControls col-4">
                <input type="text" class="input-text" value="" placeholder="" name="SignName">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-4">
                <input type="text" class="input-text" value="" placeholder="" name="TemplateCode">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-4"><span class="c-red">*</span>短信接收号码：</label>
            <div class="formControls col-4">
                <input type="text" class="input-text" value="" placeholder="" name="PhoneNumbers">
            </div>
        ...
        <div class="row cl" id="content" >
            ...
            <div class="formControls col-4">
                <input type="text" class="input-text" value="" placeholder="" name="content">
            </div>
