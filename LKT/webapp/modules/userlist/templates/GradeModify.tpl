...
<style type="text/css">
  ...
  　　　/*隐藏掉我们模型的checkbox*/
   ...
   .my_protocol .input_agreement_protocol:checked+span {
    ...
    .product_select{margin-left: 0px!important;width: 420px;height: 36px;border: 1px solid #D5DBE8;display: flex;justify-content: space-between;align-items: center;}
</style>
{/literal}
</head>
...
<nav class="nav-title">
	...
	<span><span class='arrows'>&gt;</span>编辑等级</span>
</nav>
<div class="iframe-content form-scroll" style="background-color: white;">
    <p style="font-size: 15px;" class="page_title">编辑等级</p>
    ...
    <form name="form1" id="form1" class="form form-horizontal" style="padding: 0px!important;" method="post" enctype="multipart/form-data" >
        ...
        <div class="row cl">
            ...
            <div class="formControls col-10">
               <input type="text" name="name" value="{$name}" placeholder="请输入会员等级名称" style="width: 290px!important;">
            </div>
        </div>
        ...
        <div class="row cl">
           <label class="form-label col-2" style="line-height: 25px;margin-top: 0px;padding-right: 0px;">会员字体颜色：</label>
            <div class="formControls col-10">
               <input id="mycp" type="text" class="form-control" value="{$font_color}" style="width: 290px!important;"  name="font_color" />
        ...
        <div class="row cl">
           <label class="form-label col-2" style="line-height: 25px;margin-top: 0px;padding-right: 0px;">日期字体颜色：</label>
            <div class="formControls col-10">
               <input id="mycp1" type="text" class="form-control" value="{$date_color}" style="width: 290px!important;"  name="date_color" />
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
           <label class="form-label col-2" style="line-height: 25px;margin-top: 0px;padding-right: 0px;"><span class="c-red">*</span>专属折扣：</label>
            <div class="formControls col-10" style="padding-left: -11px;float: left;">
               <input type="number" name="rate" value="{$rate}" placeholder="请输入折扣" style="width: 290px!important;padding-left: 10px;" >
               <span>折</span>
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-10">
              <div style="margin-top: 50px;margin-left: -36px;">
                {if in_array(1,$method)} 
                   <p>包月&nbsp;<input type="number" name="money" value="{$money}" style="width: 290px!important;padding-left: 10px;">&nbsp;/每月</p>
                {/if}
                {if in_array(2,$method)} 
                   <p>包季&nbsp;<input type="number" name="money_j" value="{$money_j}" style="width: 290px!important;padding-left: 10px;">&nbsp;/每季</p>
                {/if}
                {if in_array(3,$method)} 
                  <p>包年&nbsp;<input type="number" name="money_n" value="{$money_n}" style="width: 290px!important;padding-left: 10px;">&nbsp;/每年</p>
                {/if}   
              </div>
            </div>
        </div>
        <div class="row cl" style="{if $is_product != 1}display: none;{/if}">
          ...
          <div class="product_select">
            <div style="margin-left: 5px; color: #868995; font-size: 14px; padding: 7px; height: 14px; box-sizing: content-box; line-height: 14px;">
              {$pro_name}
            </div>
            <b style="margin-right: 14px;">▼</b>
          </div>
          <input id="product_i" name="pro_id" type="hidden" value="{$pro_id}">
        ...
        <div class="row cl">
           <label class="form-label col-2" style="line-height: 25px;margin-top: 0px;padding-right: 0px;"><span class="c-red">*</span>备注：</label>
            <div class="formControls col-10">
              <textarea name="remark" style="width: 290px!important;padding-left: 10px;height: 100px;">{$remark}</textarea>
            </div>
        </div>
...
function check(){
  ...
  $.ajax({
    ...
    url:'index.php?module=userlist&action=GradeModify',
    success:function(data){
