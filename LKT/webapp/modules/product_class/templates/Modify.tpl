        ...
        <table class="table table-bg table-hover " style="width: 100%;height:100px;border-radius: 30px;">
            <div class="formDivSD">
                ...
                <div class="formContentSD">
                    <input type="hidden" name="cid" class="cid" value="{$class->cid}" >
                    <input type="hidden" name="class[sid]" class="val" value="{$class->sid}" >
                    <input type="hidden" name="class[level]" class="level" value="{$class->level}" >
                    <div class="formListSD">
                        <div class="formTextSD"><span class="c-red">*</span><span>分类名称：</span></div>
                        <div class="formInputSD">
                            <input type="text" name="class[pname]" value="{$class->pname}" datatype="*6-18" placeholder="请输入分类名称" />
                        </div>
                    </div>
                    <div class="formListSD" >
                        ...
                        <div class="formInputSD upload-group multiple">
                            <div id="sortList" class="upload-preview-list uppre_auto">
                                <div class="upload-preview form_new_img" style="display: none;margin-top: -50px !important;">
                                    ...
                                    <input type="hidden" name="class[img]" class="file-item-input" value="{$class->img}">
                                </div>
                            </div>
                            <div class="select-file form_new_file from_i">
                                <div>
                                    {if $class->img}
                                        <img src="{$class->img}" data-toggle="tooltip" data-placement="bottom" title="" class="btn-secondary select-file" style="width: 78px;height: 78px;"/>
                                    {else}
