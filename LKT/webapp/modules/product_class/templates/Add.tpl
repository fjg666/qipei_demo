        ...
        <table class="table table-bg table-hover " style="width: 100%;height:100px;border-radius: 30px;">
            <div class="formDivSD">
                ...
                <div class="formContentSD">
                    ...
                    <input type="hidden" name="class[sid]" class="val" value="{$cid}">
                    <input type="hidden" name="class[level]" class="level" value="{$level}">
                    <input type="hidden" name="level_1" class="level_1" value="{$level}">
                    ...
                    <div class="formListSD" >
                        ...
                        <div class="formInputSD">
                            <select style="border: 1px solid #D5DBE8;display: flex;justify-content: center;" class="form-control link-list-select1 " name="level" onchange="slevel()" id="select_c" {if $cid != 0}disabled="disabled"{/if}>
