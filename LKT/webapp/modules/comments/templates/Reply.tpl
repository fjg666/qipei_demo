...
.plBtn{width: 112px;height: 36px;line-height: 36px;background-color:  #2890FF!important;text-align: center;
	display: block;color: #FFFFFF;font-size: 12px;border-radius: 6px;margin-right: 2px;
	position: absolute;bottom: 20px;right: 60px;}
.plBtn:hover{background-color: #2481e5!important;}

/*----------评论区域 begin----------*/
.comment-show{margin-top: 16px;margin-left: 24px;}
.comment-show-con {
    width: 100%;
}
...
.page_nav{height: 56px!important;line-height: 56px!important;}
.page_absolute{position: absolute;top:56px;right: 16px;left: 16px;bottom: 16px;background-color: white;padding: 0!important;}
.xian_h{clear: both;height: 5px;border-bottom: 1px solid #ddd;margin: 0 24px;}
</style>
{/literal}
...
<div class="commentAll page_absolute" >
    <!--回复区域 begin-->
    ...
    <!--评论区域 begin-->
    <div class="reviewArea clearfix" style="margin-top: 30px;">
