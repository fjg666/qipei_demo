...
<head>
    ...
    {*<link href="style/css/jquery.searchableSelect.css" rel="stylesheet" type="text/css">*}
...
<header class="Hui-header cl" style="margin:0;">
    ...
    <ul class="bigUl">
        ...
        {foreach from=$role_list item=item name=f1}
            <li {if $type == $item->type}class="active"{/if}><a href="index.php?module=AdminLogin&type={$item->type}">{$item->title_name}</a></li>
        {/foreach}
    </ul>
                        ...
                        <li>
                            ...
                            <div class="msgDiv2">
                                <ul class="msgUl2">
                                    <li>
                                        <div class="ifsAPI">
                                            <a _href="index.php?module=orderslist&action=Index&news_status=0&readd=0&mch_id={$mch_id}&x_order=1"  href="javascript:void(0)">
                                    ...
                                    <li>
                                        <div class="ifsAPI">
                                            <a _href="index.php?module=return&action=Index&readd=0&mch_id={$mch_id}"  href="javascript:void(0)">
                                    ...
                                    <li>
                                        <div class="ifsAPI">
                                            <a _href="index.php?module=orderslist&action=Index&news_status=1&delivery_status=1&readd=0&mch_id={$mch_id}"  href="javascript:void(0)">
...
<aside class="Hui-aside" style="background: #fff;position:fixed;top: 60px;bottom: 0px;overflow: auto !important;">
    ...
    <div class="menu_dropdown bk_2" style="padding-bottom: 40px;">
        {if $type == 0}
            <input type="hidden" id="type1" name="" value="{$type}"/>
                ...
                <dd>
                    <ul>
                        {foreach from=$item->res item=item1 name=f2}
                            {if $item1->title == '满减'}
                                <li class="textApi ifsAPI"><a _href="{$item1->url}" id="subtraction" data-title="{$item1->title}" href="javascript:void(0)">{$item1->title}</a></li>
                            {else}
                                <li class="textApi ifsAPI"><a _href="{$item1->url}" data-title="{$item1->title}" href="javascript:void(0)">{$item1->title}</a></li>
                            {/if}
                        {/foreach}
                    </ul>
                </dd>
