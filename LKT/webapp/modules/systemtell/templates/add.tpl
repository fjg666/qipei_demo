...
<div class="pd-20 page_absolute form-scroll">
    ...
    <form name="form1" id="form1" class="form form-horizontal" method="post" enctype="multipart/form-data" style="padding-top: 0; margin-top: 40px;">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-10">
                <input type="text" name="title" class="input-text"
                       style="border: 1px solid #eee;border-radius:2px;width:60%;height: 31px;line-height: 25px;padding-left: 10px;">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-10">
                <select name="telltype" class="select"
                        style="border-radius:2px;width: 180px;height: 31px;vertical-align: middle;">
        ...
        <div class="row cl" id="settimes">
            ...
            <div class="formControls col-10">
                ...
                <input type="text" name="startdate" id="startdate"
                       style="border: 1px solid #eee;border-radius:2px;height: 31px;line-height: 25px;padding-left: 10px;">
                结束时间
                <input type="text" name="enddate" id="enddate"
                       style="border: 1px solid #eee;border-radius:2px;height: 31px;line-height: 31px;padding-left: 10px;">
                <span style="color:#97a0b4;">(时间设置用来限制用户登录. 在规定时间内，用户无法登录系统)</span>
            </div>
        </div>

        <div class="row cl">
            <label class="form-label col-2" style="line-height: 25px;margin-top: 0px;">内容：</label>
            <div class="formControls col-10 sdsd">
                <script id="editor" type="text/plain" style="width:80%;height:300px;" name="detail"></script>
            </div>
        </div>
...
function check() {
    $.ajax({
        ...
        type: "POST",
        dataType: "json",
        url: 'index.php?module=systemtell&action=add',
