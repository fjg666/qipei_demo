...
.ta_btn4{border: 1px solid #2890FF!important;color: #2890FF!important;text-align: center;}
.fb_title{font-weight: bold;font-size: 16px;padding: 16px;border-bottom: 2px solid #E9ECEF}
.input-text[type="number"] {
    width: 134px;
}
.font{color: #b3b3b3}
#product_id_1 select{width: 195px;height: 36px;border-radius: 2px;border: none;vertical-align: middle;margin-right: 8px;}
.btn-blue{width: 60px;height: 36px;border-radius: 2px;background-color: #2890FF;color: #fff;font-size: 14px;border: solid 1px #2890FF;}
.butt{width: 110px!important;height: 34px!important;border-radius: 2px;text-align: center;line-height: 36px;border: solid 1px #2890FF;}
...
<div class="pd-20  ">
    <form name="form1" id="form1" class="form form-horizontal" method="post" enctype="multipart/form-data" >
            ...
            <div class="formDivSD">
                ...
                <div class="formListSD">
                    ...
                    <select name="activity_type" class="activity_type" id="activity_type" style="width:245px;height: 36px;vertical-align: middle;padding-left: 6px;" onClick="activitytype();" >
                        ...
                        {foreach from=$coupon_type item=item name=f1 key=k}
                            <option value="{$k}" {if $activity_type == $k}selected{/if}>{$item}</option>
                        {/foreach}
                    </select>
                </div>
                <div class="formListSD">
                ...
                <div class="formListSD" id="grade1" style="display: none;">
                    ...
                    <select name="grade" class="grade" id="grade" style="width:245px;height: 36px;vertical-align: middle;padding-left: 6px;" >
                        ...
                        {foreach from=$res item=item name=f1 key=k}
                            <option  value="{$item->id}" {if $grade_id == $item->id}selected{/if}>{$item->name}</option>
                        {/foreach}
                    </select>
                </div>
                <div class="formListSD" id="type_type" style="display: none;">
                    ...
                    <div class="form_new_r form_yes">
                        <input type="hidden" id="type_type1" value="{$type_type}">
                        <div class="ra1">
                            <input name="type_type"  type="radio" {if $money != 0 && $discount == 0}checked=""{/if} style="display: none;" id="type_type-1" class="inputC1" value="1" onClick="onClick_type(this)">
                            <label for="type_type-1">满减</label>
                        </div>
                        <div class="ra1">
                            <input name="type_type"  type="radio" {if $money == 0 && $discount != 0}checked=""{/if} style="display: none;" id="type_type-2" class="inputC1" value="2" onClick="onClick_type(this)">
                ...
                <div class="formListSD" id="circulation1">
                    ...
                    <div class="formInputSD">
                        <input type="text" name="circulation" id="circulation" value="{$circulation}" style="width: 125px;" />
                ...
                <div class="formListSD" id="money1" style="display: none;">
                    ...
                    <div class="formInputSD">
                        <input type="text" name="money" id="money" value="{$money}" style="width: 125px;" />
                ...
                <div class="formListSD" id="discount1" style="display: none;">
                    ...
                    <div class="formInputSD">
                        <input type="text" name="discount" id="discount" value="{$discount}" style="width: 125px;" />
                ...
                <div class="formListSD" id="z_money1">
                    ...
                    <div class="formInputSD">
                        ...
                        <input type="text" name="z_money" id="z_money" value="{$z_money}" style="width: 125px;" />
                        <span >元可使用</span>
                ...
                <div class="formListSD">
                    ...
                    <div class="form_new_r form_yes">
                        ...
                        <div class="ra1">
                            <input name="type"  type="radio" {if $type==1}checked="checked"{/if} style="display: none;" id="type-1" class="inputC1" value="1" onClick="show(this)">
                            <label for="type-1">全部商品</label>
                        </div>
                        <div class="ra1">
                            <input name="type"  type="radio" {if $type==2}checked="checked"{/if} style="display: none;" id="type-2" class="inputC1" value="2" onClick="show(this)">
                            <label for="type-2">指定商品</label>
                        </div>
                        <div class="ra1">
                            <input name="type"  type="radio" {if $type==3}checked="checked"{/if} style="display: none;" id="type-3" class="inputC1" value="3" onClick="show(this)">
                ...
                <div class="formListSD" id="container" style="display: none;height: 150px;">
                    ...
                    <div class="content_wrap">
                        <input type="text" id="classSel" value="" autocomplete="off" placeholder="请输入关键字" onclick="showMenu();" />
                        ...
                        <div id="menuContent" class="menuContent" style="display:none; position: absolute;left: 170px;top: 36px;">
                ...
                <div class="formListSD" id="option_container" style="display: none;">
                    ...
                    <input type="hidden" name="product_class_name" id="product_class_name" value="{$product_class_name}">
                ...
                <div class="formListSD">
                    ...
                    <div class="form_new_r form_yes">
                        <div class="ra1">
                            <input name="skip_type"  type="radio" {if $skip_type == 1}checked="checked"{/if} style="display: none;" id="skip_type-1" class="inputC1" value="1" onClick="skip(this)">
                            <label for="skip_type-1">首页</label>
                        </div>
                        <div class="ra1">
                            <input name="skip_type"  type="radio" {if $skip_type == 2}checked="checked"{/if} style="display: none;" id="skip_type-2" class="inputC1" value="2" onClick="skip(this)">
                ...
                <div class="formListSD" id="url1" style="display: none;">
                    ...
                    <div class="formInputSD">
                        <input type="text" name="url" id="url" value="{$url}" style="width: 500px;" />
                    </div>
                </div>
                ...
                <div class="formListSD" id="receive1" >
                    ...
                    <div class="formInputSD" {if $limit_type != 1}style="display: none;" {/if}>
                        ...
                        <input type="number" name="receive" value="{$receive}" style="width: 125px;" />
                        <span >张</span>
                    </div>
                </div>
                <div class="formListSD" id="time2" style="display: none;">
                    ...
                    <div class="formInputSD" >
                        ...
                        <input type="number" name="day" value="{$day}" style="width: 125px;" />
                        <span >天可使用</span>
                    </div>
                </div>
                <div class="formListSD" id="receive1" >
        ...
        <div class="page_h10 page_bort" style="height: 70px!important;">
...
<script>
// 初始指定商品, 分类
var initSelProducts, initSelClass;
$(function() {
    var obj = $("#type").val();
    var obj1 = $("#type_type1").val();
    ...
    if (obj == '1') { // 全部商品
        ...
        document.getElementById('option_container').style.display = ""; // 优惠劵类型id
        $('#container').height(36)
        chaxun('product');
        ...
        if(product_name.length > 0){
            var list = product_name.split(',');
            initSelProducts = list;
            var res = '';
            for (i=0;i<list.length;i++){
                res += '<div class="option_container">'+
                    ...
                    '<span class="option_container_1" onclick="del(\''+list[i]+'\',\''+product_name+'\')">X</span>'+
                    '</div>'+
                    '</div>';
            }
            $("#option_container_1").append(res);
        }
        $("#menu_list").val(product_name);
    } else if (obj == '3') { // 指定分类
        document.getElementById('container').style.display = ""; // 优惠劵类型id
        ...
        $('#container').height(36)
        chaxun('fenlei');
        var product_class_name = $("#product_class_name").val();
        $("#option_container_1").empty();
        if(product_class_name.length > 0){
            var list = product_class_name.split(',');
            initSelClass = list;
            var res = '';
            for (i=0;i<list.length;i++){
                res += '<div class="option_container">'+
                    '<div style=" overflow:hidden; text-overflow:ellipsis; white-space: nowrap; display: inline-block;">'+list[i]+
                    '<span class="option_container_1" onclick="del(\''+list[i]+'\',\''+product_class_name+'\')">X</span>'+
                    '</div>'+
                    '</div>';
            }
            $("#option_container_1").append(res);
        }
        $("#menu_list").val(product_class_name);
    }
...
function chaxun(canshu,searchName) {
    $.ajax({
        ...
        success: function (data) {
            ...
            // 初始化指定商品或分类
            if(initSelProducts){
                for(var i=0; i<initSelProducts.length; i++){
                    for(var j=0; j<nodes.length; j++){
                        if(nodes[j].name==initSelProducts[i]){
                            treeObj.checkNode(nodes[j],true,true,true);
                            confirmBtnClick()
                        }
                    }
                }
            }else if(initSelClass){
                for(var i=0; i<initSelClass.length; i++){
                    for(var j=0; j<nodes.length; j++){
                        if(nodes[j].name==initSelClass[i]){
                            treeObj.checkNode(nodes[j],true,true,true);
                            confirmBtnClick()
                        }
                    }
...
//判断已选项是否有值 2指定商品 3指定分类
function isValue(type){
    //已选项的初始内容
    var _productVal = document.getElementById('product_name').value;
    var _classVal = document.getElementById('product_class_name').value;
    if(type==2){
        if(_productVal){
...
function showMenu() {
    ...
    $("#menuContent").css({left:170 + "px", top:36 + "px"}).slideDown("fast");
