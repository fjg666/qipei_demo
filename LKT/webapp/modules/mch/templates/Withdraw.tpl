...
<div class="pd-20 page_absolute">
			...
			<tbody>
				{foreach from=$list item=item name=f1}
	                <tr class="text-c tab_td">
	                    ...
	                    <td class="tab_editor">
							{if $button[5] == 1}
								<a title="通过" href="javascript:void(0);" onclick="examine(this,1,'{$item->id}','{$item->user_id}','{$item->money}','{$item->s_charge}','index.php?module=mch&action=Withdraw_examine')" >
									<img src="images/icon1/sx.png"/>&nbsp;通过
								</a>
								<a title="拒绝" href="javascript:void(0);" onclick="examine(this,2,'{$item->id}','{$item->user_id}','{$item->money}','{$item->s_charge}','index.php?module=mch&action=Withdraw_examine')">
	...
	<div class='tb_tab' style="text-align: center;display: flex;justify-content: center;">{$pages_show}</div>
</div>
