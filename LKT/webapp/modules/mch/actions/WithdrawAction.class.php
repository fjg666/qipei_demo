...
class WithdrawAction extends Action {
    ...
    public function getDefaultView() {
        ...
        $button[5] = $JurisdictionAction->Jurisdiction($store_id,$admin_name,$admin_type1,'index.php?module=mch&action=Withdraw_examine');
        ...
        $url = "index.php?module=mch&action=Withdraw&name=".urlencode($name)."&mobile=".urlencode($mobile)."&startdate=".urlencode($startdate)."&enddate=".urlencode($enddate)."&pagesize=".urlencode($pagesize);
