				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline" style="background-color: transparent;box-shadow: none;margin-bottom: 0px;">
						<div class="panel-body">
							...
							<input type="hidden" name="day2" value="{$day_show_1}">
							<input type="hidden" name="day3" value="{$day_show_2}">
							<input type="hidden" name="day4" value="{$day_show_3}">
							<input type="hidden" name="day5" value="{$day_show_4}">
							<input type="hidden" name="day6" value="{$day_show_5}">
							<input type="hidden" name="day7" value="{$day_show_6}">

							<input type="hidden" name="user_num01" value="{$user_num01}">
							<input type="hidden" name="user_num02" value="{$user_num02}">
							<input type="hidden" name="user_num03" value="{$user_num03}">
							<input type="hidden" name="user_num04" value="{$user_num04}">
							<input type="hidden" name="user_num05" value="{$user_num05}">
							<input type="hidden" name="user_num06" value="{$user_num06}">
							<input type="hidden" name="user_num07" value="{$user_num07}">
								...
								<div class="mainRight">
									<div class="tjtDiv" style="height: 315px;background: transparent;">
										<div class="member">
											...
											<div class="title1" style="float: right; margin-right: 20px">累计会员: {$user_num} 人</div>
