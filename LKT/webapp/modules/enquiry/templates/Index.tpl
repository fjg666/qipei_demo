    ...
    <div class="mt-20 table-scroll" style="background: #fff;">
        <table class="table-border tab_content">
            ...
            <tr class="text-c tab_tr">
                ...
                <th width="130">车型名字</th>
                <th width="150">是否有商户报价</th>
                <th width="150">报价时间</th>
                <th width="130">询价时间</th>
            </tr>
            </thead>
            <tbody>
            {foreach from=$list item=item name=f1}
                <tr class="text-c tab_td">
                    ...
                    <td>{if $item->is_baojia == 1}已报价{elseif $item->is_baojia == 2}未报价{/if}</td>
                    <td>{$item->baojia_date}</td>
