        ...
        <div id="tab-category" class="HuiTab">
            <div class="tabCon">
                <div style="height:490px;overflow-y: scroll;">
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-9"
                             style="background-color: #F5F5F5;margin-bottom: 10px;border-radius: 5px;padding: 10px;">
                            <input class="btn btn-primary radius" type="button" value="&nbsp;&nbsp;添加人数&nbsp;&nbsp;"
                                   style="height: 36px!important;" onclick="addlever()">
                            <div style="margin:10px;" id="setlevel">
                                <div class="manlevel">
                                    <input type="number" max="50" min="1" class="input-text" value="" name="min_man"
                                    ...
                                    <input type="number" class="input-text" value="" name="memberprice"
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-9">
                            <input type="number" min="1" class="input-text" value="" placeholder="" id=""
                                   name="timehour" style="width:60px;" onkeyup="onkeyup1(this)"><span> 小时 </span>
                        ...
                        <div class="formControls col-xs-8 col-sm-9">
                            <div style="margin-top: 0px;">
                                <input type="radio" value="2" placeholder="" id="endtime" name="endtime"
                                       onchange="radioChange(2)" checked><span style="margin-left: 10px;">定期结束</span>
                                <input type="text" class="input-text" autocomplete="off" value="" placeholder=""
                                       id="group_end_time" name="group_end_time" style="width:150px;margin-left: 10px;">
                            </div>
                            <div style="margin-top: 15px;">
                                <input type="radio" value="1" placeholder="" id="ctime" name="endtime"
                                       onchange="radioChange(1)">
                                <span style="margin-left: 10px;">长期</span>
                                <input type="text" class="input-text" autocomplete="off" value="" placeholder=""
                                       id="end_year" name="end_year" style="width:150px;margin-left: 34px;" disabled>
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-9">
                            <input type="number" min="1" class="input-text" value="" placeholder="" id=""
                                   name="groupnum" style="width:60px;" onkeyup="onkeyup1(this)">
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-9">
                            <input type="number" min="1" class="input-text" value="" placeholder="" id=""
                                   name="productnum" style="width:60px;" onkeyup="onkeyup1(this)">
                ...
                <div class="row cl page_footer">
                    <div>
                        <input class="btn btn-primary radius ta_btn4" onclick='javascript:history.back(-1)' type="reset"
                               value="取消" style="background: #fff!important;">
