                  ...
                  <table class="table-border tab_content {if count($arr)>10}table-sort{/if}" style="">
                   ...
                   <tr class="text-c tab_tr">
                      ...
                      <th width="180">规格</th>
		                  ...
		                  <!-- <th width="180">拼团价格<div style="color:#666666;font-size: 10px;">(双击可进行设置)</div></th>
		                  <th width="150">团长优惠价</th> -->
		               </tr>
                     </thead>
                     <tbody>
	                   {foreach from=$arr item=item name=f1}
                         ...
                         <td>{$item->price}</td>
	                       <!-- <td id="{$item->id}">
	                    	    <input type="text" style="width:80px;height:30px;line-height: 30px;margin-left: 10px;border:1px solid #eee" id="set_price_{$item->id}" name="canprice" value="{$item->price}" data-id="{$item->id}" onkeyup="gDecimal(this,{$item->id})">              	    
	                       </td>                       
	                       <td>
	                            ...
	                            <input type="text" style="width:80px;height:30px;line-height: 30px;margin-left: 10px;border:1px solid #eee" data-id="{$item->id}" id="price_member_{$item->id}" onkeyup="checkDecimal(this,{$item->id})" value="{$item->price}" onblur="memberPrice({$item->id})"/>
	                         		</div>
		                       	</div>
                         </td> -->                 
	                     </tr>
