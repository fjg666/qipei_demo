                        ...
                        {foreach from=$list item=item name=f1}
                            <tr class="text-c" style="height:20px;">
                                ...
                                {if $status < 1}
                                    <td id="{$item->id}">
                                        <input type="number"
                                               style="height: 36px;line-height: 36px;border: 1px solid #eee;padding-left: 20px;"
                                               name="modify_group_{$item->id}" id="set_group_{$item->id}"
                                               value="{$item->group_price}">
                                    </td>
                                    <td id="m{$item->id}">
                                        <input type="number"
                                               style="height: 36px;line-height: 36px;border: 1px solid #eee;padding-left: 20px;"
                                               name="modify_member_{$item->id}" id="set_member_{$item->id}"
                                               value="{$item->member_price}">
                                    </td>
                                {else}
                                    <td id="{$item->id}">
                                ...
                                {/if}
                                {if $status < 1}
                                    <td><a style="width: 60px;display: block;" title="删除产品" href="javascript:;"
                                           onclick="system_category_del(this,{$item->id},1)" class="ml-5">
