                ...
                <tr class="text-c tab_td">
                    ...
                    <td class="tab_editor">
                        <div class="tab_editor_center">
							<a style="text-decoration:none;" class="ml-5" href="index.php?module=plug_ins&action=Modify&id={$item->id}" title="编辑" >
							...
							<a style="text-decoration:none" class="ml-5" href="javascript:void(0);" onclick="confirm('确定要删除此插件吗?',{$item->id},'index.php?module=plug_ins&action=Del&id=','删除')">
							    <div style="align-items: center;font-size: 12px;display: flex;">
							        <div style="margin:0 auto;;display: flex;align-items: center;"> 
