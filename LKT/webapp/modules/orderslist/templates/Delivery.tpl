    ...
    <form name="form1" id="form1" class="form form-horizontal" method="post" enctype="multipart/form-data">
            ...
            <table class="table" style="width: 98%">
                ...
                {foreach from=$goods item=item name=f1}
                    <tr>
                        ...
                        <td>{$item->p_name}</td>
                        <td class="center"><img class='pimg' src="{$item->imgurl}"
                                                style="margin-right: 20px;margin-left: 15px;" width="50" height="50"/>
                        </td>
                        <td class="center"><span class="grText">{$item->num}</span></td>
                        <td class="center"><span class="grText">￥{$item->p_price}
                            {if $item->p_integral}+<img src="images/icon/integral_hei.png" alt="" style="width: 15px;height: 15px;margin: -4px 2px 0 2px;">{$item->p_integral}{/if}
                        </span></td>
        ...
        <div style="background-color: white;" class="row_cl">
            <div style="float:  right;margin-right: 60px;width: 112px;">
                <button onclick="send_btn_dd('{$goods[0]->otype}','{$goods[0]->r_sNo}')" type="button" class="butten_o">
                    发货
                </button>
            </div>
