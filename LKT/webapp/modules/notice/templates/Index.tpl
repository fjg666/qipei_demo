...
<div class="pd-20 page_absolute">
    {if $button[0] == 1}
        <div style="clear:both;" class="page_bgcolor">
            <a class="btn newBtn radius" href="index.php?module=notice&action=add"><img src="images/icon1/add.png"/>&nbsp;发布公告</a>
        </div>
    {/if}
        ...
        <table class="table-border tab_content">
            ...
            {if $list != ''}
                ...
                <tr class="text-c tab_td">
                    ...
                    <td>{$item->name}</td>
                    <td><image class='pimg' src="{$item->img_url}" style="width: 100px;"/></td>
                    <td class="tab_time">{$item->time}</td>
                    <td class="tab_editor">
                        {if $button[1] == 1}
                        ...
                        {/if}
                        {if $button[2] == 1}
                            <a style="text-decoration:none" class="ml-5" href="" onclick="confirm('确定要删除此公告吗?','{$item->id}','index.php?module=notice&action=del&id=','删除')">
