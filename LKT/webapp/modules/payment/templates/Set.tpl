...
<div class="pd-20 page_absolute form-scroll">
	<div class="page_title">
		{if !$payments->name}添加支付方式{else}修改支付方式{/if}
	</div>
        ...
        <div class="formDivSD">
            <div class="formContentSD">
                <div class="formListSD" style="margin: 2px 0px;">
                    ...
                    <div class="formInputSD">
                        <label class="radio-label">
                            <input type="radio" name="status" value="0" {if $payments->status == 0}checked{/if}>
                            <span class="label-icon"></span>
                            <span class="label-text">开启</span>
                        </label>
                        <label class="radio-label">
                            <input type="radio" name="status" value="1" {if $payments->status == 1}checked{/if}>
                            <span class="label-icon"></span>
                ...
                <div class="formListSD" style="margin: 2px 0px;">
                    ...
                    <div class="formInputSD">
                        <input class="form-control border-d5d" name="name" value="{$payments->name}" style="width: 500px;">
                    </div>
                </div>
                <div class="formListSD" style="margin: 2px 0px;">
                    ...
                    <div class="formInputSD">
                        <label class="radio-label">
                            <input type="radio" name="client_type" value="1" {if $payments->client_type == 1}checked{/if}>
                            <span class="label-icon"></span>
                            <span class="label-text">PC端</span>
                        </label>
                        <label class="radio-label">
                            <input type="radio" name="client_type" value="2" {if $payments->client_type == 2}checked{/if}>
                            <span class="label-icon"></span>
                            <span class="label-text">移动端</span>
                        </label>
                        <label class="radio-label">
                            <input type="radio" name="client_type" value="3" {if $payments->client_type == 3}checked{/if}>
                            <span class="label-icon"></span>
                ...
                <div class="formListSD" style="margin: 2px 0px;">
                    ...
                    <div class="formInputSD">
                        <label class="radio-label" >
                            <input type="radio" name="poundage_type" onclick="$('#paymentFeeText').text('商品总额的百分比：');" value="0" {if $payments->poundage_type == 0}checked{/if}>
                            <span class="label-icon"></span>
                            <span class="label-text">按商品总额的百分比</span>
                        </label>
                        <label class="radio-label">
                            <input type="radio" name="poundage_type" onclick="$('#paymentFeeText').text('按固定金额：');" value="1" {if $payments->poundage_type == 1}checked{/if}>
                            <span class="label-icon"></span>
                ...
                <div class="formListSD" style="margin: 2px 0px 10px;">
                    ...
                    <div class="formInputSD">
                        <span class="input-group-addon border-d5d" id='paymentFeeText' style="height: 36px;">{if $payments->poundage_type == 0}商品总额的百分比：{else}按固定金额：{/if}</span>
                        <input class="form-control border-d5d" name="poundage" value="{$payments->poundage}" style="width: 352px;">
                    </div>
                </div>
                <div class="formListSD" style="margin: 2px 0px 10px;">
                    <div class="formTextSD"><span class="color414">排序号：</span></div>
                    <div class="formInputSD" style="flex:1">
                        <input class="form-control border-d5d" name="sort" value="{$payments->sort}" style="width: 500px;">
                ...
                <div class="formListSD" style="margin: 2px 0px;">
                    ...
                    <div class="formInputSD">
                        <textarea class="form-control border-d5d" name="note" rows="8" style="width: 500px;">{$payments->note}</textarea>
                    </div>
                </div>
                    ...
                    <div class="formInputSD" style="flex:1;width:100px">
                        <div class="upload-group">
                            <div class="input-group row" style="margin-left: -84px;margin-top: 2px;">
                                ...
                                <input index="0" value="{$logo}" name="logo" class="col-sm-5 col-md-5 col-lg-5 form-control file-input input_width_l border-d5d" style="width: 1008px;height: 36px;">
