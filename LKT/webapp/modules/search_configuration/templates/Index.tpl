        ...
        <div id="tab-system" class="HuiTab">
            <div class="row cl">
                ...
                <div class="formControls col-2">
                    <div class="status_box">
                        <input type="hidden" class="status" name="is_open" id="is_open" value="{$is_open}">
                        <div class="wrap" style="{if $is_open==1}background-color:#5eb95e;{else}background-color: #ccc;{/if}">
                            <div class="circle" style="{if $is_open==1}left:30px;{else}left:0px;{/if}"></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-3">
                    <input type="text" name="num" value="{$num}" class="input-text">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-2" style="width: 13% !important;">关键词：</label>
                <div class="formControls col-xs-8 col-sm-6">
                    <textarea rows="3" cols="60" name="keyword">{$keyword}</textarea>
                    <span style="color: #97A0B4;">关键词请用逗号隔开</span>
                </div>
            </div>
            {*<div class="row cl">*}
                {*<label class="form-label col-2" style="width: 13% !important;">店铺关键词：</label>*}
                {*<div class="formControls col-xs-8 col-sm-6">*}
                    {*<textarea rows="3" cols="60" name="mch_keyword">*}
                        {*{$mch_keyword}*}
                    {*</textarea>*}
                {*</div>*}
            {*</div>*}
