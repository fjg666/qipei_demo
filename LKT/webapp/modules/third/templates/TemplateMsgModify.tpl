    ...
    <form name="form1" id="form1" class="form form-horizontal" method="post" enctype="multipart/form-data" style="padding: 10px 0;">
        ...
        <div class="row cl page_padd">
            ...
            <div class="formControls col-4">
                <input type="text" class="input-text" value="{$res->c_name}" placeholder="" name="c_name">
            </div>
        </div>
        <div class="row cl page_padd">
            <label class="form-label col-4"><span class="c-red">*</span>模板消息对应字段：</label>
            <div class="formControls col-4">
                <input type="text" class="input-text" value="{$res->e_name}" placeholder="" name="e_name">
            </div>
        </div>
        ...
        <div class="row cl page_padd">
            ...
            <div class="formControls col-4">
                <input type="text" class="input-text" value="{$res->stock_id}" placeholder="" name="stock_id">
            </div>
        </div>
        ...
        <div class="row cl page_padd">
            ...
            <div class="formControls col-4">
                <input type="text" class="input-text" value="{$res->stock_key}" placeholder="" name="stock_key">
            </div>
    ...
    <script>
        ...
        function check() {
            $.ajax({
                ...
                type: "POST",
                dataType:"json",
                url:'index.php?module=third&action=TemplateMsgModify&m=edit',
