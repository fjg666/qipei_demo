    ...
    <form name="form1" id="form1" class="form form-horizontal" method="post" enctype="multipart/form-data" style="padding: 0 10px;margin-top: 40px;">
        ...
        <div class="row cl page_padd">
            ...
            <div class="formControls col-4">
                <input type="text" class="input-text" value="{$appid}" placeholder="" name="appid">
            </div>
        </div>
        <div class="row cl page_padd">
            <label class="form-label col-4"><span class="c-red">*</span>第三方平台秘钥：</label>
            <div class="formControls col-4">
                <input type="text" class="input-text" value="{$appsecret}" placeholder="" name="appsecret">
            </div>
        </div>
        ...
        <div class="row cl page_padd">
            ...
            <div class="formControls col-4">
                <input type="text" class="input-text" value="{$check_token}" placeholder="" name="check_token">
            </div>
        </div>
        ...
        <div class="row cl page_padd">
            ...
            <div class="formControls col-4">
                <input type="text" class="input-text" value="{$encrypt_key}" placeholder="" name="encrypt_key">
            </div>
        ...
        <div class="row cl page_padd">
            ...
            <div class="formControls col-8">
                <input type="text" class="input-text" value="{$serve_domain}" name="serve_domain" placeholder="">
        ...
        <div class="row cl page_padd">
            ...
            <div class="formControls col-8">
                <input type="text" class="input-text" value="{$work_domain}" name="work_domain" placeholder="">
        ...
        <div class="row cl page_padd">
            ...
            <div class="formControls col-8">
                <input type="text" class="input-text" value="{$redirect_url}" name="redirect_url" placeholder="">
        ...
        <div class="row cl page_padd">
            ...
            <div class="formControls col-8">
                <input type="text" class="input-text" value="{$mini_url}" name="mini_url" placeholder="">
        ...
        <div class="row cl page_padd">
            ...
            <div class="formControls col-8">
                <input type="text" class="input-text" value="{$kefu_url}" name="kefu_url" placeholder="">
        ...
        <div class="row cl page_padd">
            ...
            <div class="formControls col-8">
                <input type="text" class="input-text" value="{$qr_code}" name="qr_code" placeholder="">
        ...
        <!-- <div class="row cl page_padd">
            ...
            <div class="formControls col-8">
                <input type="text" class="input-text" value="{$H5}" name="H5" placeholder="">
        ...
        <div class="row cl page_padd">
            ...
            <div class="formControls col-8">
                <input type="text" class="input-text" value="{$endurl}" name="endurl" placeholder="">
