...
<html>
	...
	<head>
		...
		<link href="style/css/style.css" rel="stylesheet" type="text/css" /> {include file="../../include_path/software_head.tpl" sitename="DIY头部"}
		<title>系统参数</title>
		{literal}
		<link rel="stylesheet" type="text/css" href="style/css/index.css" /> {/literal}
	</head>
	...
	<body class="body_bgcolor">
		...
		<div class="outer_page">
			...
			<section class="i_section">
				<div class="headimg">
					<img src="{$head_img}" style="width: 100px;height: 100px">
				</div>
				<h1>
					{$nick_name}
				</h1>
			...
			<section class="i_section">
				...
				<div class="QR1">
					...
					<div class="examine">
						<img src="{$qr_code}" width="150px" height="150px">
						<text>用微信扫描二维码</text>
					</div>
				</div>
			</section>
			...
			<section class="i_section">
				...
				<div class="verify">
					...
					发布状态：{if $status == 1}<text style="color: red">审核失败</text>{elseif $status === 0 && $issue_mark == 1}<text style="color:green ">审核成功，请前往发布</text>{elseif $status === 0 && $issue_mark == 3}<text style="color:green ">已发布</text>{/if}
