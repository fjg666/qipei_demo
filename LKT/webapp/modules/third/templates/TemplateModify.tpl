...
<div class="main-body">
    <div class="panel mb-3" style="position: static;">
         <nav class="breadcrumb page_bgcolor">
                    ...
                    <span  class="c-gray en">&gt;</span>
                    <span  style='color: #414658;'>编辑模板</span>
        </nav>
        <div class="panel-body pd-20 page_absolute">
			<div style="font-weight:bold;border-bottom: 2px solid rgb(233, 236, 239);height: 60px;display: flex;align-items: center;padding-left: 20px;font-size: 16px;">编辑模板</div>
            <form name="form1" id="form1" class="form form-horizontal" method="post" enctype="multipart/form-data" style="padding-left: 50px;">
                    ...
                    <div class=" text-right">
                        ...
                        <div class="upload-group">
                            <div class="input-group row">
                                <span class="col-form-label col-sm-1 col-md-1 col-lg-1"><font
                            ...
                            <div class="input-group row">
                            	<span class=" col-sm-1 col-md-1 col-lg-1"><font color="red">*</font>行业：</span>
                            	<select name="trade_data"  style="width: 300px;max-width: 25%;border: 1px solid #D5DBE8;display: flex;justify-content: center;" class="form-control link-list-select1 ">
                            		...
                            		<option value="{$item->trade_code}" {if $item->trade_code == $res_c->trade_data}selected="selected"{/if}>{$item->trade_text}</option>
                            		{/foreach}
                            	</select>
                            ...
                            <div class="input-group row">
                                <span class="col-sm-1 col-md-1 col-lg-1">模板展示图：</span>
                                <input index="0" value="{$res_c->image}" name="img_url"
                                       class="form-control input_fy input_width col-sm-3 col-md-3 col-lg-3 file-input ">
									   <!-- col-sm-1 col-md-1 col-lg-1 -->
                                <span class="input-group-btn input_a" style="width: 100px;"><a
                                            href="javascript:" data-toggle="tooltip" data-placement="bottom"
                                            title="" class="btn  select-file"
                                    >选择文件</a></span>
                                <span class="input-group-btn input_border" style="width:100px"><a
                                            href="javascript:" data-toggle="tooltip" data-placement="bottom"
                                            class="btn upload-file">上传文件</a></span>
                            </div>
                            <div class="upload-preview text-center upload-preview position_l" style="top: 100px;width: 240px;height: 340px;left:60%;">
                                <div class='border_img'  style="width: 240px;height: 340px;">
                                    {if $res_c->image}
                                        <img src="{$res_c->image}" class="upload-preview-img jkl"  style="width: 240px;height: 340px;">
                                    {else}
                            ...
                            <div class="input-group row">
                                ...
                                <input type="text" name="template_id"
                                       class="form-control input_fy input_width col-sm-3 col-md-3 col-lg-3"
                                       value="{$res_c->template_id}">
                            </div>

                            <div class="input-group row">
                            	<span class="col-form-label col-sm-1 col-md-1 col-lg-1"><font color=red>*</font>模板简介：</span>
                            	<textarea name="lk_desc" class="form-control input_fy input_width col-sm-3 col-md-3 col-lg-3" style="height: 100px;"> {$res_c->lk_desc}</textarea>	
                            </div>
                        </div>
				...
				<div class="bottomBtnWrap page_bort" style="display: flex!important;">
...
<script>
    ...
    function check() {
        ...
        $.ajax({
            ...
            type: "POST",
            dataType: "json",
            url: 'index.php?module=third&action=TemplateModify&m=edit',
            data: $('#form1').serialize()+'&id='+id,// 你的formid
            async: true,
            success: function (data) {
                ...
                if(data.suc == 1){
                    ...
                    setTimeout(function(){location.href='index.php?module=third&action=Template';}
                        ,2000);
